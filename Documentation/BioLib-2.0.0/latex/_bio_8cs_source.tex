...
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l06162}06162         \textcolor{keyword}{public} \textcolor{keyword}{static} \mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a69033204d904c06f11952bbef3228977}{OpenOME}}(\textcolor{keywordtype}{string} file, \textcolor{keywordtype}{int} serie, \textcolor{keywordtype}{bool} tab, \textcolor{keywordtype}{bool} addToImages, \textcolor{keywordtype}{bool} tile, \textcolor{keywordtype}{int} tilex, \textcolor{keywordtype}{int} tiley, \textcolor{keywordtype}{int} tileSizeX, \textcolor{keywordtype}{int} tileSizeY)}
...
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07317}07317                 \textcolor{stringliteral}{"{}PhysicalSizeX=\(\backslash\)"{}"{}} + bis[px][s].PhysicalSizeX + \textcolor{stringliteral}{"{}\(\backslash\)"{} PhysicalSizeXUnit=\(\backslash\)"{}µm\(\backslash\)"{} PhysicalSizeY=\(\backslash\)"{}"{}} + bis[px][s].PhysicalSizeY + \textcolor{stringliteral}{"{}\(\backslash\)"{} PhysicalSizeYUnit=\(\backslash\)"{}µm\(\backslash\)"{} SignificantBits=\(\backslash\)"{}"{}} + bis[px][s].bitsPerPixel + \textcolor{stringliteral}{"{}\(\backslash\)"{} "{}} +}
...
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07362}07362                     mutated.Tiffsave(file, compression, 1, Enums.ForeignTiffPredictor.None, \textcolor{keyword}{null},ss[px].Width, ss[px].Height, \textcolor{keyword}{true}, \textcolor{keyword}{false}, 16,}
...
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07366}07366                     mutated.Tiffsave(file, compression, 1, Enums.ForeignTiffPredictor.None, \textcolor{keyword}{null}, ss[px].Width, ss[px].Height, \textcolor{keyword}{true}, \textcolor{keyword}{false}, 8,}
...
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07744}07744         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{bool} OmeSupport = \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07745}07745         \textcolor{keyword}{static} \textcolor{keywordtype}{bool} supportDialog = \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07755}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_aced4701731fa1ab8467ca36935c9276e}{07755}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{bool} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_aced4701731fa1ab8467ca36935c9276e}{OMESupport}}()}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07756}07756         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07757}07757             \textcolor{keywordtype}{bool} isMacOS = RuntimeInformation.IsOSPlatform(OSPlatform.OSX);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07758}07758             \textcolor{keywordflow}{if} (RuntimeInformation.OSArchitecture == Architecture.Arm64 \&\& isMacOS)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07759}07759             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07760}07760                 OmeSupport = \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07761}07761                 \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07762}07762             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07763}07763             \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07764}07764             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07765}07765                 OmeSupport = \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07766}07766                 \textcolor{keywordflow}{return} \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07767}07767             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07768}07768         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07769}07769         \textcolor{keyword}{static} NetVips.Image netim;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07780}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a51b8f8a482fa882cc88917b6e9d3eee3}{07780}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{bool} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a51b8f8a482fa882cc88917b6e9d3eee3}{VipsSupport}}(\textcolor{keywordtype}{string} file)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07781}07781         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07782}07782             \textcolor{keywordflow}{try}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07783}07783             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07784}07784                 netim = NetVips.Image.Tiffload(file);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07785}07785                 Settings.AddSettings(\textcolor{stringliteral}{"{}VipsSupport"{}}, \textcolor{stringliteral}{"{}true"{}});}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07786}07786             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07787}07787             \textcolor{keywordflow}{catch} (Exception e)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07788}07788             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07789}07789                 Console.WriteLine(e.ToString());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07790}07790                 \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07791}07791             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07792}07792             netim.Close();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07793}07793             netim.Dispose();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07794}07794             \textcolor{keywordflow}{return} \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07795}07795         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07796}07796         \textcolor{keyword}{private} \textcolor{keyword}{static} Stopwatch st = \textcolor{keyword}{new} Stopwatch();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07797}07797         \textcolor{keyword}{private} \textcolor{keyword}{static} ServiceFactory factory;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07798}07798         \textcolor{keyword}{private} \textcolor{keyword}{static} OMEXMLService service;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07799}07799         \textcolor{keyword}{private} \textcolor{keyword}{static} ImageReader reader;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07800}07800         \textcolor{keyword}{private} \textcolor{keyword}{static} ImageWriter writer;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07801}07801         \textcolor{keyword}{private} loci.formats.meta.IMetadata meta;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07802}07802 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07803}07803         \textcolor{comment}{//We use UNIX type line endings since they are supported by ImageJ \& Bio.}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07804}07804         \textcolor{keyword}{public} \textcolor{keyword}{const} \textcolor{keywordtype}{char} NewLine = \textcolor{charliteral}{'\(\backslash\)n'};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07805}07805         \textcolor{keyword}{public} \textcolor{keyword}{const} \textcolor{keywordtype}{string} columns = \textcolor{stringliteral}{"{}ROIID,ROINAME,TYPE,ID,SHAPEINDEX,TEXT,S,C,Z,T,X,Y,W,H,POINTS,STROKECOLOR,STROKECOLORW,FILLCOLOR,FONTSIZE\(\backslash\)n"{}};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07806}07806 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07815}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a1d657e6a06da2033f15bed33a408268f}{07815}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{string} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a1d657e6a06da2033f15bed33a408268f}{OpenXML}}(\textcolor{keywordtype}{string} file)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07816}07816         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07817}07817             \textcolor{keywordflow}{if} (!file.EndsWith(\textcolor{stringliteral}{"{}.tif"{}}))}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07818}07818                 \textcolor{keywordflow}{return} \textcolor{keyword}{null};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07819}07819             Tiff image = Tiff.Open(file, \textcolor{stringliteral}{"{}r"{}});}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07820}07820             FieldValue[] f = image.GetField(TiffTag.IMAGEDESCRIPTION);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07821}07821             \textcolor{keywordflow}{return} f[0].ToString();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07822}07822         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07823}07823 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07824}07824         \textcolor{keyword}{public} \textcolor{keyword}{static} List<ROI> OpenOMEROIs(\textcolor{keywordtype}{string} file, \textcolor{keywordtype}{int} series)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07825}07825         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07826}07826             \textcolor{keywordflow}{if} (!\mbox{\hyperlink{class_bio_lib_1_1_bio_image_aced4701731fa1ab8467ca36935c9276e}{OMESupport}}())}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07827}07827                 \textcolor{keywordflow}{return} \textcolor{keyword}{null};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07828}07828             List<ROI> Annotations = \textcolor{keyword}{new} List<ROI>();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07829}07829             \textcolor{comment}{// create OME-\/XML metadata store}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07830}07830             ServiceFactory factory = \textcolor{keyword}{new} ServiceFactory();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07831}07831             OMEXMLService service = (OMEXMLService)factory.getInstance(typeof(OMEXMLService));}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07832}07832             loci.formats.ome.OMEXMLMetadata meta = service.createOMEXMLMetadata();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07833}07833             \textcolor{comment}{// create format reader}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07834}07834             ImageReader imageReader = \textcolor{keyword}{new} ImageReader();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07835}07835             imageReader.setMetadataStore(meta);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07836}07836             \textcolor{comment}{// initialize file}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07837}07837             file = file.Replace(\textcolor{stringliteral}{"{}\(\backslash\)\(\backslash\)"{}}, \textcolor{stringliteral}{"{}/"{}});}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07838}07838             imageReader.setId(file);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07839}07839             \textcolor{keywordtype}{int} imageCount = imageReader.getImageCount();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07840}07840             \textcolor{keywordtype}{int} seriesCount = imageReader.getSeriesCount();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07841}07841             \textcolor{keywordtype}{double} physicalSizeX = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07842}07842             \textcolor{keywordtype}{double} physicalSizeY = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07843}07843             \textcolor{keywordtype}{double} physicalSizeZ = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07844}07844             \textcolor{keywordtype}{double} stageSizeX = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07845}07845             \textcolor{keywordtype}{double} stageSizeY = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07846}07846             \textcolor{keywordtype}{double} stageSizeZ = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07847}07847             \textcolor{keywordtype}{int} SizeX = imageReader.getSizeX();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07848}07848             \textcolor{keywordtype}{int} SizeY = imageReader.getSizeY();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07849}07849             \textcolor{keywordtype}{int} SizeZ = imageReader.getSizeY();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07850}07850             \textcolor{keywordflow}{try}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07851}07851             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07852}07852                 \textcolor{keywordtype}{bool} hasPhysical = \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07853}07853                 \textcolor{keywordflow}{if} (meta.getPixelsPhysicalSizeX(series) != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07854}07854                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07855}07855                     physicalSizeX = meta.getPixelsPhysicalSizeX(series).value().doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07856}07856                     hasPhysical = \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07857}07857                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07858}07858                 \textcolor{keywordflow}{if} (meta.getPixelsPhysicalSizeY(series) != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07859}07859                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07860}07860                     physicalSizeY = meta.getPixelsPhysicalSizeY(series).value().doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07861}07861                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07862}07862                 \textcolor{keywordflow}{if} (meta.getPixelsPhysicalSizeZ(series) != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07863}07863                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07864}07864                     physicalSizeZ = meta.getPixelsPhysicalSizeZ(series).value().doubleValue();}
...
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07868}07868                     physicalSizeZ = 1;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07869}07869                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07870}07870                 \textcolor{keywordflow}{if} (meta.getStageLabelX(series) != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07871}07871                     stageSizeX = meta.getStageLabelX(series).value().doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07872}07872                 \textcolor{keywordflow}{if} (meta.getStageLabelY(series) != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07873}07873                     stageSizeY = meta.getStageLabelY(series).value().doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07874}07874                 \textcolor{keywordflow}{if} (meta.getStageLabelZ(series) != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07875}07875                     stageSizeZ = meta.getStageLabelZ(series).value().doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07876}07876                 \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07877}07877                     stageSizeZ = 1;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07878}07878             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07879}07879             \textcolor{keywordflow}{catch} (Exception e)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07880}07880             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07881}07881                 stageSizeX = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07882}07882                 stageSizeY = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07883}07883                 stageSizeZ = 1;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07884}07884             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07885}07885             VolumeD volume = \textcolor{keyword}{new} VolumeD(\textcolor{keyword}{new} Point3D(stageSizeX, stageSizeY, stageSizeZ), \textcolor{keyword}{new} Point3D(physicalSizeX * SizeX, physicalSizeY * SizeY, physicalSizeZ * SizeZ));}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07886}07886             \textcolor{keywordtype}{int} rc = meta.getROICount();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07887}07887             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} im = 0; im < rc; im++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07888}07888             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07889}07889                 \textcolor{keywordtype}{string} roiID = meta.getROIID(im);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07890}07890                 \textcolor{keywordtype}{string} roiName = meta.getROIName(im);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07891}07891                 ZCT co = \textcolor{keyword}{new} ZCT(0, 0, 0);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07892}07892                 \textcolor{keywordtype}{int} scount = 1;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07893}07893                 \textcolor{keywordflow}{try}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07894}07894                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07895}07895                     scount = meta.getShapeCount(im);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07896}07896                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07897}07897                 \textcolor{keywordflow}{catch} (Exception e)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07898}07898                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07899}07899                     Console.WriteLine(e.Message.ToString());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07900}07900                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07901}07901                 \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} sc = 0; sc < scount; sc++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07902}07902                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07903}07903                     \textcolor{keywordtype}{string} type = meta.getShapeType(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07904}07904                     ROI an = \textcolor{keyword}{new} ROI();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07905}07905                     an.roiID = roiID;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07906}07906                     an.roiName = roiName;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07907}07907                     an.shapeIndex = sc;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07908}07908                     \textcolor{keywordflow}{if} (type == \textcolor{stringliteral}{"{}Point"{}})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07909}07909                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07910}07910                         an.type = ROI.Type.Point;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07911}07911                         an.id = meta.getPointID(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07912}07912                         \textcolor{keywordtype}{double} dx = meta.getPointX(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07913}07913                         \textcolor{keywordtype}{double} dy = meta.getPointY(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07914}07914                         an.AddPoint(\mbox{\hyperlink{class_bio_lib_1_1_bio_image_aa8f5cb51957438be6c15d0cb79dc36fe}{ToStageSpace}}(\textcolor{keyword}{new} PointD(dx, dy), physicalSizeX, physicalSizeY, volume.Location.X, volume.Location.Y));}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07915}07915                         an.coord = \textcolor{keyword}{new} ZCT();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07916}07916                         ome.xml.model.primitives.NonNegativeInteger nz = meta.getPointTheZ(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07917}07917                         \textcolor{keywordflow}{if} (nz != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07918}07918                             an.coord.Z = nz.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07919}07919                         ome.xml.model.primitives.NonNegativeInteger nc = meta.getPointTheC(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07920}07920                         \textcolor{keywordflow}{if} (nc != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07921}07921                             an.coord.C = nc.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07922}07922                         ome.xml.model.primitives.NonNegativeInteger nt = meta.getPointTheT(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07923}07923                         \textcolor{keywordflow}{if} (nt != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07924}07924                             an.coord.T = nt.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07925}07925                         an.Text = meta.getPointText(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07926}07926                         ome.units.quantity.Length fl = meta.getPointFontSize(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07927}07927                         \textcolor{keywordflow}{if} (fl != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07928}07928                             an.fontSize = fl.value().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07929}07929                         an.family = meta.getPointFontFamily(im, sc).name();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07930}07930                         ome.xml.model.primitives.Color col = meta.getPointStrokeColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07931}07931                         \textcolor{keywordflow}{if} (col != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07932}07932                             an.strokeColor = Color.FromArgb(col.getAlpha(), col.getRed(), col.getGreen(), col.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07933}07933                         ome.units.quantity.Length fw = meta.getPointStrokeWidth(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07934}07934                         \textcolor{keywordflow}{if} (fw != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07935}07935                             an.strokeWidth = (float)fw.value().floatValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07936}07936                         ome.xml.model.primitives.Color colf = meta.getPointStrokeColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07937}07937                         \textcolor{keywordflow}{if} (colf != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07938}07938                             an.fillColor = Color.FromArgb(colf.getAlpha(), colf.getRed(), colf.getGreen(), colf.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07939}07939                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07940}07940                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07941}07941                     \textcolor{keywordflow}{if} (type == \textcolor{stringliteral}{"{}Line"{}})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07942}07942                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07943}07943                         an.type = ROI.Type.Line;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07944}07944                         an.id = meta.getLineID(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07945}07945                         \textcolor{keywordtype}{double} px1 = meta.getLineX1(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07946}07946                         \textcolor{keywordtype}{double} py1 = meta.getLineY1(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07947}07947                         \textcolor{keywordtype}{double} px2 = meta.getLineX2(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07948}07948                         \textcolor{keywordtype}{double} py2 = meta.getLineY2(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07949}07949                         an.AddPoint(\mbox{\hyperlink{class_bio_lib_1_1_bio_image_aa8f5cb51957438be6c15d0cb79dc36fe}{ToStageSpace}}(\textcolor{keyword}{new} PointD(px1, py1), physicalSizeX, physicalSizeY, volume.Location.X, volume.Location.Y));}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07950}07950                         an.AddPoint(\mbox{\hyperlink{class_bio_lib_1_1_bio_image_aa8f5cb51957438be6c15d0cb79dc36fe}{ToStageSpace}}(\textcolor{keyword}{new} PointD(px2, py2), physicalSizeX, physicalSizeY, volume.Location.X, volume.Location.Y));}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07951}07951                         ome.xml.model.primitives.NonNegativeInteger nz = meta.getLineTheZ(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07952}07952                         \textcolor{keywordflow}{if} (nz != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07953}07953                             co.Z = nz.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07954}07954                         ome.xml.model.primitives.NonNegativeInteger nc = meta.getLineTheC(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07955}07955                         \textcolor{keywordflow}{if} (nc != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07956}07956                             co.C = nc.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07957}07957                         ome.xml.model.primitives.NonNegativeInteger nt = meta.getLineTheT(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07958}07958                         \textcolor{keywordflow}{if} (nt != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07959}07959                             co.T = nt.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07960}07960                         an.coord = co;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07961}07961                         an.Text = meta.getLineText(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07962}07962                         ome.units.quantity.Length fl = meta.getLineFontSize(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07963}07963                         \textcolor{keywordflow}{if} (fl != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07964}07964                             an.fontSize = fl.value().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07965}07965                         an.family = meta.getPointFontFamily(im, sc).name();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07966}07966                         ome.xml.model.primitives.Color col = meta.getLineStrokeColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07967}07967                         \textcolor{keywordflow}{if} (col != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07968}07968                             an.strokeColor = Color.FromArgb(col.getAlpha(), col.getRed(), col.getGreen(), col.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07969}07969                         ome.units.quantity.Length fw = meta.getLineStrokeWidth(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07970}07970                         \textcolor{keywordflow}{if} (fw != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07971}07971                             an.strokeWidth = (float)fw.value().floatValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07972}07972                         ome.xml.model.primitives.Color colf = meta.getLineFillColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07973}07973                         \textcolor{keywordflow}{if} (colf != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07974}07974                             an.fillColor = Color.FromArgb(colf.getAlpha(), colf.getRed(), colf.getGreen(), colf.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07975}07975                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07976}07976                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07977}07977                     \textcolor{keywordflow}{if} (type == \textcolor{stringliteral}{"{}Rectangle"{}})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07978}07978                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07979}07979                         an.type = ROI.Type.Rectangle;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07980}07980                         an.id = meta.getRectangleID(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07981}07981                         \textcolor{keywordtype}{double} px = meta.getRectangleX(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07982}07982                         \textcolor{keywordtype}{double} py = meta.getRectangleY(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07983}07983                         \textcolor{keywordtype}{double} pw = meta.getRectangleWidth(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07984}07984                         \textcolor{keywordtype}{double} ph = meta.getRectangleHeight(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07985}07985                         an.Rect = \mbox{\hyperlink{class_bio_lib_1_1_bio_image_aa8f5cb51957438be6c15d0cb79dc36fe}{ToStageSpace}}(\textcolor{keyword}{new} RectangleD(px, py, pw, ph), physicalSizeX, physicalSizeY, volume.Location.X, volume.Location.Y);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07986}07986                         ome.xml.model.primitives.NonNegativeInteger nz = meta.getRectangleTheZ(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07987}07987                         \textcolor{keywordflow}{if} (nz != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07988}07988                             co.Z = nz.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07989}07989                         ome.xml.model.primitives.NonNegativeInteger nc = meta.getRectangleTheC(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07990}07990                         \textcolor{keywordflow}{if} (nc != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07991}07991                             co.C = nc.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07992}07992                         ome.xml.model.primitives.NonNegativeInteger nt = meta.getRectangleTheT(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07993}07993                         \textcolor{keywordflow}{if} (nt != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07994}07994                             co.T = nt.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07995}07995                         an.coord = co;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07996}07996 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07997}07997                         an.Text = meta.getRectangleText(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07998}07998                         ome.units.quantity.Length fl = meta.getRectangleFontSize(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l07999}07999                         \textcolor{keywordflow}{if} (fl != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08000}08000                             an.fontSize = fl.value().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08001}08001                         an.family = meta.getPointFontFamily(im, sc).name();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08002}08002                         ome.xml.model.primitives.Color col = meta.getRectangleStrokeColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08003}08003                         \textcolor{keywordflow}{if} (col != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08004}08004                             an.strokeColor = Color.FromArgb(col.getAlpha(), col.getRed(), col.getGreen(), col.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08005}08005                         ome.units.quantity.Length fw = meta.getRectangleStrokeWidth(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08006}08006                         \textcolor{keywordflow}{if} (fw != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08007}08007                             an.strokeWidth = (float)fw.value().floatValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08008}08008                         ome.xml.model.primitives.Color colf = meta.getRectangleFillColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08009}08009                         \textcolor{keywordflow}{if} (colf != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08010}08010                             an.fillColor = Color.FromArgb(colf.getAlpha(), colf.getRed(), colf.getGreen(), colf.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08011}08011                         ome.xml.model.enums.FillRule fr = meta.getRectangleFillRule(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08012}08012                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08013}08013                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08014}08014                     \textcolor{keywordflow}{if} (type == \textcolor{stringliteral}{"{}Ellipse"{}})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08015}08015                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08016}08016                         an.type = ROI.Type.Ellipse;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08017}08017                         an.id = meta.getEllipseID(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08018}08018                         \textcolor{keywordtype}{double} px = meta.getEllipseX(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08019}08019                         \textcolor{keywordtype}{double} py = meta.getEllipseY(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08020}08020                         \textcolor{keywordtype}{double} ew = meta.getEllipseRadiusX(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08021}08021                         \textcolor{keywordtype}{double} eh = meta.getEllipseRadiusY(im, sc).doubleValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08022}08022                         \textcolor{comment}{//We convert the ellipse radius to Rectangle}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08023}08023                         \textcolor{keywordtype}{double} w = ew * 2;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08024}08024                         \textcolor{keywordtype}{double} h = eh * 2;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08025}08025                         \textcolor{keywordtype}{double} x = px -\/ ew;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08026}08026                         \textcolor{keywordtype}{double} y = py -\/ eh;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08027}08027                         an.Rect = \mbox{\hyperlink{class_bio_lib_1_1_bio_image_aa8f5cb51957438be6c15d0cb79dc36fe}{ToStageSpace}}(\textcolor{keyword}{new} RectangleD(px, py, w, h), physicalSizeX, physicalSizeY, volume.Location.X, volume.Location.Y);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08028}08028                         ome.xml.model.primitives.NonNegativeInteger nz = meta.getEllipseTheZ(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08029}08029                         \textcolor{keywordflow}{if} (nz != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08030}08030                             co.Z = nz.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08031}08031                         ome.xml.model.primitives.NonNegativeInteger nc = meta.getEllipseTheC(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08032}08032                         \textcolor{keywordflow}{if} (nc != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08033}08033                             co.C = nc.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08034}08034                         ome.xml.model.primitives.NonNegativeInteger nt = meta.getEllipseTheT(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08035}08035                         \textcolor{keywordflow}{if} (nt != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08036}08036                             co.T = nt.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08037}08037                         an.coord = co;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08038}08038                         an.Text = meta.getEllipseText(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08039}08039                         ome.units.quantity.Length fl = meta.getEllipseFontSize(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08040}08040                         \textcolor{keywordflow}{if} (fl != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08041}08041                             an.fontSize = fl.value().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08042}08042                         an.family = meta.getPointFontFamily(im, sc).name();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08043}08043                         ome.xml.model.primitives.Color col = meta.getEllipseStrokeColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08044}08044                         \textcolor{keywordflow}{if} (col != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08045}08045                             an.strokeColor = Color.FromArgb(col.getAlpha(), col.getRed(), col.getGreen(), col.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08046}08046                         ome.units.quantity.Length fw = meta.getEllipseStrokeWidth(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08047}08047                         \textcolor{keywordflow}{if} (fw != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08048}08048                             an.strokeWidth = (float)fw.value().floatValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08049}08049                         ome.xml.model.primitives.Color colf = meta.getEllipseFillColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08050}08050                         \textcolor{keywordflow}{if} (colf != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08051}08051                             an.fillColor = Color.FromArgb(colf.getAlpha(), colf.getRed(), colf.getGreen(), colf.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08052}08052                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08053}08053                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08054}08054                     \textcolor{keywordflow}{if} (type == \textcolor{stringliteral}{"{}Polygon"{}})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08055}08055                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08056}08056                         an.type = ROI.Type.Polygon;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08057}08057                         an.id = meta.getPolygonID(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08058}08058                         an.closed = \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08059}08059                         \textcolor{keywordtype}{string} pxs = meta.getPolygonPoints(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08060}08060                         PointD[] pts = an.stringToPoints(pxs);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08061}08061                         pts = \mbox{\hyperlink{class_bio_lib_1_1_bio_image_aa8f5cb51957438be6c15d0cb79dc36fe}{ToStageSpace}}(pts, physicalSizeX, physicalSizeY, volume.Location.X, volume.Location.Y);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08062}08062                         \textcolor{keywordflow}{if} (pts.Length > 100)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08063}08063                         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08064}08064                             an.type = ROI.Type.Freeform;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08065}08065                         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08066}08066                         an.AddPoints(pts);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08067}08067                         ome.xml.model.primitives.NonNegativeInteger nz = meta.getPolygonTheZ(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08068}08068                         \textcolor{keywordflow}{if} (nz != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08069}08069                             co.Z = nz.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08070}08070                         ome.xml.model.primitives.NonNegativeInteger nc = meta.getPolygonTheC(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08071}08071                         \textcolor{keywordflow}{if} (nc != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08072}08072                             co.C = nc.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08073}08073                         ome.xml.model.primitives.NonNegativeInteger nt = meta.getPolygonTheT(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08074}08074                         \textcolor{keywordflow}{if} (nt != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08075}08075                             co.T = nt.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08076}08076                         an.coord = co;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08077}08077                         an.Text = meta.getPolygonText(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08078}08078                         ome.units.quantity.Length fl = meta.getPolygonFontSize(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08079}08079                         \textcolor{keywordflow}{if} (fl != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08080}08080                             an.fontSize = fl.value().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08081}08081                         an.family = meta.getPointFontFamily(im, sc).name();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08082}08082                         ome.xml.model.primitives.Color col = meta.getPolygonStrokeColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08083}08083                         \textcolor{keywordflow}{if} (col != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08084}08084                             an.strokeColor = Color.FromArgb(col.getAlpha(), col.getRed(), col.getGreen(), col.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08085}08085                         ome.units.quantity.Length fw = meta.getPolygonStrokeWidth(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08086}08086                         \textcolor{keywordflow}{if} (fw != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08087}08087                             an.strokeWidth = (float)fw.value().floatValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08088}08088                         ome.xml.model.primitives.Color colf = meta.getPolygonFillColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08089}08089                         \textcolor{keywordflow}{if} (colf != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08090}08090                             an.fillColor = Color.FromArgb(colf.getAlpha(), colf.getRed(), colf.getGreen(), colf.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08091}08091                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08092}08092                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08093}08093                     \textcolor{keywordflow}{if} (type == \textcolor{stringliteral}{"{}Polyline"{}})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08094}08094                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08095}08095                         an.type = ROI.Type.Polyline;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08096}08096                         an.id = meta.getPolylineID(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08097}08097                         \textcolor{keywordtype}{string} pxs = meta.getPolylinePoints(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08098}08098                         PointD[] pts = an.stringToPoints(pxs);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08099}08099                         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} pi = 0; pi < pts.Length; pi++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08100}08100                         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08101}08101                             pts[pi] = \mbox{\hyperlink{class_bio_lib_1_1_bio_image_aa8f5cb51957438be6c15d0cb79dc36fe}{ToStageSpace}}(pts[pi], physicalSizeX, physicalSizeY, volume.Location.X, volume.Location.Y);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08102}08102                         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08103}08103                         an.AddPoints(an.stringToPoints(pxs));}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08104}08104                         ome.xml.model.primitives.NonNegativeInteger nz = meta.getPolylineTheZ(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08105}08105                         \textcolor{keywordflow}{if} (nz != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08106}08106                             co.Z = nz.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08107}08107                         ome.xml.model.primitives.NonNegativeInteger nc = meta.getPolylineTheC(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08108}08108                         \textcolor{keywordflow}{if} (nc != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08109}08109                             co.C = nc.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08110}08110                         ome.xml.model.primitives.NonNegativeInteger nt = meta.getPolylineTheT(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08111}08111                         \textcolor{keywordflow}{if} (nt != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08112}08112                             co.T = nt.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08113}08113                         an.coord = co;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08114}08114                         an.Text = meta.getPolylineText(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08115}08115                         ome.units.quantity.Length fl = meta.getPolylineFontSize(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08116}08116                         \textcolor{keywordflow}{if} (fl != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08117}08117                             an.fontSize = fl.value().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08118}08118                         an.family = meta.getPointFontFamily(im, sc).name();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08119}08119                         ome.xml.model.primitives.Color col = meta.getPolylineStrokeColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08120}08120                         \textcolor{keywordflow}{if} (col != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08121}08121                             an.strokeColor = Color.FromArgb(col.getAlpha(), col.getRed(), col.getGreen(), col.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08122}08122                         ome.units.quantity.Length fw = meta.getPolylineStrokeWidth(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08123}08123                         \textcolor{keywordflow}{if} (fw != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08124}08124                             an.strokeWidth = (float)fw.value().floatValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08125}08125                         ome.xml.model.primitives.Color colf = meta.getPolylineFillColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08126}08126                         \textcolor{keywordflow}{if} (colf != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08127}08127                             an.fillColor = Color.FromArgb(colf.getAlpha(), colf.getRed(), colf.getGreen(), colf.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08128}08128                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08129}08129                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08130}08130                     \textcolor{keywordflow}{if} (type == \textcolor{stringliteral}{"{}Label"{}})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08131}08131                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08132}08132                         an.type = ROI.Type.Label;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08133}08133                         an.id = meta.getLabelID(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08134}08134 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08135}08135                         ome.xml.model.primitives.NonNegativeInteger nz = meta.getLabelTheZ(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08136}08136                         \textcolor{keywordflow}{if} (nz != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08137}08137                             co.Z = nz.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08138}08138                         ome.xml.model.primitives.NonNegativeInteger nc = meta.getLabelTheC(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08139}08139                         \textcolor{keywordflow}{if} (nc != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08140}08140                             co.C = nc.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08141}08141                         ome.xml.model.primitives.NonNegativeInteger nt = meta.getLabelTheT(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08142}08142                         \textcolor{keywordflow}{if} (nt != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08143}08143                             co.T = nt.getNumberValue().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08144}08144                         an.coord = co;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08145}08145 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08146}08146                         ome.units.quantity.Length fl = meta.getLabelFontSize(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08147}08147                         \textcolor{keywordflow}{if} (fl != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08148}08148                             an.fontSize = fl.value().intValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08149}08149                         an.family = meta.getPointFontFamily(im, sc).name();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08150}08150                         ome.xml.model.primitives.Color col = meta.getLabelStrokeColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08151}08151                         \textcolor{keywordflow}{if} (col != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08152}08152                             an.strokeColor = Color.FromArgb(col.getAlpha(), col.getRed(), col.getGreen(), col.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08153}08153                         ome.units.quantity.Length fw = meta.getLabelStrokeWidth(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08154}08154                         \textcolor{keywordflow}{if} (fw != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08155}08155                             an.strokeWidth = (float)fw.value().floatValue();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08156}08156                         ome.xml.model.primitives.Color colf = meta.getLabelFillColor(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08157}08157                         \textcolor{keywordflow}{if} (colf != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08158}08158                             an.fillColor = Color.FromArgb(colf.getAlpha(), colf.getRed(), colf.getGreen(), colf.getBlue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08159}08159                         PointD p = \textcolor{keyword}{new} PointD(meta.getLabelX(im, sc).doubleValue(), meta.getLabelY(im, sc).doubleValue());}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08160}08160                         an.AddPoint(\mbox{\hyperlink{class_bio_lib_1_1_bio_image_aa8f5cb51957438be6c15d0cb79dc36fe}{ToStageSpace}}(p, physicalSizeX, physicalSizeY, volume.Location.X, volume.Location.Y));}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08161}08161                         an.Text = meta.getLabelText(im, sc);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08162}08162                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08163}08163                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08164}08164             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08165}08165 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08166}08166             imageReader.close();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08167}08167             \textcolor{keywordflow}{return} Annotations;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08168}08168         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08169}08169 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08177}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_acc1cc8dfbef8164e1345098a7151a1bc}{08177}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{string} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_acc1cc8dfbef8164e1345098a7151a1bc}{ROIsToString}}(List<ROI> Annotations)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08178}08178         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08179}08179             \textcolor{keywordtype}{string} s = \textcolor{stringliteral}{"{}"{}};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08180}08180             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < Annotations.Count; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08181}08181             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08182}08182                 s += \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a1bd82ed44eb2ee1b78b02f1f1a97102b}{ROIToString}}(Annotations[i]);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08183}08183             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08184}08184             \textcolor{keywordflow}{return} s;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08185}08185         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08186}08186 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08197}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a1bd82ed44eb2ee1b78b02f1f1a97102b}{08197}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{string} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a1bd82ed44eb2ee1b78b02f1f1a97102b}{ROIToString}}(\mbox{\hyperlink{class_bio_lib_1_1_r_o_i}{ROI}} an)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08198}08198         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08199}08199             PointD[] points = an.\mbox{\hyperlink{class_bio_lib_1_1_r_o_i_a46ac91df835d2cfa668e6c6b1fb25382}{GetPoints}}();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08200}08200             \textcolor{keywordtype}{string} pts = \textcolor{stringliteral}{"{}"{}};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08201}08201             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} j = 0; j < points.Length; j++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08202}08202             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08203}08203                 \textcolor{keywordflow}{if} (j == points.Length -\/ 1)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08204}08204                     pts += points[j].X.ToString(CultureInfo.InvariantCulture) + \textcolor{stringliteral}{"{},"{}} + points[j].Y.ToString(CultureInfo.InvariantCulture);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08205}08205                 \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08206}08206                     pts += points[j].X.ToString(CultureInfo.InvariantCulture) + \textcolor{stringliteral}{"{},"{}} + points[j].Y.ToString(CultureInfo.InvariantCulture) + \textcolor{stringliteral}{"{} "{}};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08207}08207             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08208}08208             \textcolor{keywordtype}{char} sep = (char)34;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08209}08209             \textcolor{keywordtype}{string} sColor = sep.ToString() + an.strokeColor.A.ToString() + \textcolor{charliteral}{','} + an.strokeColor.R.ToString() + \textcolor{charliteral}{','} + an.strokeColor.G.ToString() + \textcolor{charliteral}{','} + an.strokeColor.B.ToString() + sep.ToString();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08210}08210             \textcolor{keywordtype}{string} bColor = sep.ToString() + an.fillColor.A.ToString() + \textcolor{charliteral}{','} + an.fillColor.R.ToString() + \textcolor{charliteral}{','} + an.fillColor.G.ToString() + \textcolor{charliteral}{','} + an.fillColor.B.ToString() + sep.ToString();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08211}08211 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08212}08212             \textcolor{keywordtype}{string} line = an.roiID + \textcolor{charliteral}{','} + an.roiName + \textcolor{charliteral}{','} + an.type.ToString() + \textcolor{charliteral}{','} + an.id + \textcolor{charliteral}{','} + an.shapeIndex.ToString() + \textcolor{charliteral}{','} +}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08213}08213                 an.Text + \textcolor{charliteral}{','} + an.serie + \textcolor{charliteral}{','} + an.coord.Z.ToString() + \textcolor{charliteral}{','} + an.coord.C.ToString() + \textcolor{charliteral}{','} + an.coord.T.ToString() + \textcolor{charliteral}{','} + an.X.ToString(CultureInfo.InvariantCulture) + \textcolor{charliteral}{','} + an.Y.ToString(CultureInfo.InvariantCulture) + \textcolor{charliteral}{','} +}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08214}08214                 an.W.ToString(CultureInfo.InvariantCulture) + \textcolor{charliteral}{','} + an.H.ToString(CultureInfo.InvariantCulture) + \textcolor{charliteral}{','} + sep.ToString() + pts + sep.ToString() + \textcolor{charliteral}{','} + sColor + \textcolor{charliteral}{','} + an.strokeWidth.ToString(CultureInfo.InvariantCulture) + \textcolor{charliteral}{','} + bColor + \textcolor{charliteral}{','} + an.fontSize.ToString(CultureInfo.InvariantCulture) + \textcolor{charliteral}{','} + NewLine;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08215}08215             \textcolor{keywordflow}{return} line;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08216}08216         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08227}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a616c510a1434e4cbcef43b0f10db3993}{08227}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \mbox{\hyperlink{class_bio_lib_1_1_r_o_i}{ROI}} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a616c510a1434e4cbcef43b0f10db3993}{StringToROI}}(\textcolor{keywordtype}{string} sts)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08228}08228         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08229}08229             \textcolor{comment}{//Works with either comma or tab separated values.}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08230}08230             \textcolor{keywordflow}{if} (sts.StartsWith(\textcolor{stringliteral}{"{}<?xml"{}}) || sts.StartsWith(\textcolor{stringliteral}{"{}\{"{}}))}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08231}08231                 \textcolor{keywordflow}{return} \textcolor{keyword}{null};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08232}08232             \mbox{\hyperlink{class_bio_lib_1_1_r_o_i}{ROI}} an = \textcolor{keyword}{new} \mbox{\hyperlink{class_bio_lib_1_1_r_o_i}{ROI}}();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08233}08233             \textcolor{keywordtype}{string} val = \textcolor{stringliteral}{"{}"{}};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08234}08234             \textcolor{keywordtype}{bool} inSep = \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08235}08235             \textcolor{keywordtype}{int} col = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08236}08236             \textcolor{keywordtype}{double} x = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08237}08237             \textcolor{keywordtype}{double} y = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08238}08238             \textcolor{keywordtype}{double} w = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08239}08239             \textcolor{keywordtype}{double} h = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08240}08240             \textcolor{keywordtype}{string} line = sts;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08241}08241             \textcolor{keywordtype}{bool} points = \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08242}08242             \textcolor{keywordtype}{char} sep = \textcolor{charliteral}{'"{}'};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08243}08243             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < line.Length; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08244}08244             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08245}08245                 \textcolor{keywordtype}{char} c = line[i];}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08246}08246                 \textcolor{keywordflow}{if} (c == sep)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08247}08247                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08248}08248                     \textcolor{keywordflow}{if} (!inSep)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08249}08249                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08250}08250                         inSep = \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08251}08251                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08252}08252                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08253}08253                         inSep = \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08254}08254                     \textcolor{keywordflow}{continue};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08255}08255                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08256}08256 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08257}08257                 \textcolor{keywordflow}{if} ((c == \textcolor{charliteral}{','} || c == \textcolor{charliteral}{'\(\backslash\)t'}) \&\& (!inSep || points))}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08258}08258                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08259}08259                     \textcolor{comment}{//ROIID,ROINAME,TYPE,ID,SHAPEINDEX,TEXT,C,Z,T,X,Y,W,H,POINTS,STROKECOLOR,STROKECOLORW,FILLCOLOR,FONTSIZE}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08260}08260                     \textcolor{keywordflow}{if} (col == 0)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08261}08261                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08262}08262                         \textcolor{comment}{//ROIID}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08263}08263                         an.roiID = val;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08264}08264                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08265}08265                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08266}08266                     \textcolor{keywordflow}{if} (col == 1)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08267}08267                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08268}08268                         \textcolor{comment}{//ROINAME}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08269}08269                         an.roiName = val;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08270}08270                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08271}08271                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08272}08272                     \textcolor{keywordflow}{if} (col == 2)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08273}08273                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08274}08274                         \textcolor{comment}{//TYPE}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08275}08275                         an.type = (\mbox{\hyperlink{class_bio_lib_1_1_r_o_i}{ROI}}.Type)Enum.Parse(typeof(\mbox{\hyperlink{class_bio_lib_1_1_r_o_i}{ROI}}.Type), val);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08276}08276                         \textcolor{keywordflow}{if} (an.type == \mbox{\hyperlink{class_bio_lib_1_1_r_o_i}{ROI}}.Type.Freeform || an.type == \mbox{\hyperlink{class_bio_lib_1_1_r_o_i}{ROI}}.Type.Polygon)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08277}08277                             an.closed = \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08278}08278                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08279}08279                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08280}08280                     \textcolor{keywordflow}{if} (col == 3)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08281}08281                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08282}08282                         \textcolor{comment}{//ID}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08283}08283                         an.id = val;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08284}08284                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08285}08285                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08286}08286                     \textcolor{keywordflow}{if} (col == 4)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08287}08287                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08288}08288                         \textcolor{comment}{//SHAPEINDEX/}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08289}08289                         an.shapeIndex = \textcolor{keywordtype}{int}.Parse(val);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08290}08290                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08291}08291                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08292}08292                     \textcolor{keywordflow}{if} (col == 5)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08293}08293                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08294}08294                         \textcolor{comment}{//TEXT/}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08295}08295                         an.Text = val;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08296}08296                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08297}08297                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08298}08298                     \textcolor{keywordflow}{if} (col == 6)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08299}08299                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08300}08300                         an.serie = \textcolor{keywordtype}{int}.Parse(val);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08301}08301                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08302}08302                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08303}08303                     \textcolor{keywordflow}{if} (col == 7)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08304}08304                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08305}08305                         an.coord.Z = \textcolor{keywordtype}{int}.Parse(val);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08306}08306                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08307}08307                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08308}08308                     \textcolor{keywordflow}{if} (col == 8)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08309}08309                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08310}08310                         an.coord.C = \textcolor{keywordtype}{int}.Parse(val);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08311}08311                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08312}08312                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08313}08313                     \textcolor{keywordflow}{if} (col == 9)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08314}08314                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08315}08315                         an.coord.T = \textcolor{keywordtype}{int}.Parse(val);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08316}08316                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08317}08317                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08318}08318                     \textcolor{keywordflow}{if} (col == 10)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08319}08319                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08320}08320                         x = \textcolor{keywordtype}{double}.Parse(val, CultureInfo.InvariantCulture);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08321}08321                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08322}08322                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08323}08323                     \textcolor{keywordflow}{if} (col == 11)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08324}08324                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08325}08325                         y = \textcolor{keywordtype}{double}.Parse(val, CultureInfo.InvariantCulture);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08326}08326                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08327}08327                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08328}08328                     \textcolor{keywordflow}{if} (col == 12)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08329}08329                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08330}08330                         w = \textcolor{keywordtype}{double}.Parse(val, CultureInfo.InvariantCulture);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08331}08331                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08332}08332                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08333}08333                     \textcolor{keywordflow}{if} (col == 13)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08334}08334                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08335}08335                         h = \textcolor{keywordtype}{double}.Parse(val, CultureInfo.InvariantCulture);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08336}08336                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08337}08337                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08338}08338                     \textcolor{keywordflow}{if} (col == 14)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08339}08339                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08340}08340                         \textcolor{comment}{//POINTS}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08341}08341                         an.\mbox{\hyperlink{class_bio_lib_1_1_r_o_i_adf4c7167c4ac9a63e0177e97a6ee030a}{AddPoints}}(an.\mbox{\hyperlink{class_bio_lib_1_1_r_o_i_a6b33717a4c97372d0a94d7c5c8080169}{stringToPoints}}(val));}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08342}08342                         points = \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08343}08343                         an.Rect = \textcolor{keyword}{new} \mbox{\hyperlink{struct_bio_lib_1_1_rectangle_d}{RectangleD}}(x, y, w, h);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08344}08344                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08345}08345                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08346}08346                     \textcolor{keywordflow}{if} (col == 15)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08347}08347                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08348}08348                         \textcolor{comment}{//STROKECOLOR}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08349}08349                         \textcolor{keywordtype}{string}[] st = val.Split(\textcolor{charliteral}{','});}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08350}08350                         an.strokeColor = Color.FromArgb(\textcolor{keywordtype}{int}.Parse(st[0]), \textcolor{keywordtype}{int}.Parse(st[1]), \textcolor{keywordtype}{int}.Parse(st[2]), \textcolor{keywordtype}{int}.Parse(st[3]));}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08351}08351                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08352}08352                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08353}08353                     \textcolor{keywordflow}{if} (col == 16)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08354}08354                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08355}08355                         \textcolor{comment}{//STROKECOLORW}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08356}08356                         an.strokeWidth = \textcolor{keywordtype}{double}.Parse(val, CultureInfo.InvariantCulture);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08357}08357                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08358}08358                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08359}08359                     \textcolor{keywordflow}{if} (col == 17)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08360}08360                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08361}08361                         \textcolor{comment}{//FILLCOLOR}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08362}08362                         \textcolor{keywordtype}{string}[] st = val.Split(\textcolor{charliteral}{','});}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08363}08363                         an.fillColor = Color.FromArgb(\textcolor{keywordtype}{int}.Parse(st[0]), \textcolor{keywordtype}{int}.Parse(st[1]), \textcolor{keywordtype}{int}.Parse(st[2]), \textcolor{keywordtype}{int}.Parse(st[3]));}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08364}08364                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08365}08365                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08366}08366                     \textcolor{keywordflow}{if} (col == 18)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08367}08367                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08368}08368                         \textcolor{comment}{//FONTSIZE}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08369}08369                         \textcolor{keywordtype}{double} s = \textcolor{keywordtype}{double}.Parse(val, CultureInfo.InvariantCulture);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08370}08370                         an.fontSize = (float)s;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08371}08371                         an.family = \textcolor{stringliteral}{"{}Times New Roman"{}};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08372}08372                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08373}08373                     col++;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08374}08374                     val = \textcolor{stringliteral}{"{}"{}};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08375}08375                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08376}08376                 \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08377}08377                     val += c;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08378}08378             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08379}08379 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08380}08380             \textcolor{keywordflow}{return} an;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08381}08381         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08382}08382 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08390}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a3630ab9b3a2e82e6d733b122d8035c89}{08390}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{void} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a3630ab9b3a2e82e6d733b122d8035c89}{ExportROIsCSV}}(\textcolor{keywordtype}{string} filename, List<ROI> Annotations)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08391}08391         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08392}08392             \textcolor{keywordtype}{string} con = columns;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08393}08393             con += \mbox{\hyperlink{class_bio_lib_1_1_bio_image_acc1cc8dfbef8164e1345098a7151a1bc}{ROIsToString}}(Annotations);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08394}08394             File.WriteAllText(filename, con);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08395}08395         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08396}08396 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08406}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_ae74e13dfef39281cd92b663a08971131}{08406}}         \textcolor{keyword}{public} \textcolor{keyword}{static} List<ROI> \mbox{\hyperlink{class_bio_lib_1_1_bio_image_ae74e13dfef39281cd92b663a08971131}{ImportROIsCSV}}(\textcolor{keywordtype}{string} filename)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08407}08407         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08408}08408             List<ROI> list = \textcolor{keyword}{new} List<ROI>();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08409}08409             \textcolor{keywordflow}{if} (!File.Exists(filename))}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08410}08410                 \textcolor{keywordflow}{return} list;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08411}08411             \textcolor{keywordtype}{string}[] sts = File.ReadAllLines(filename);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08412}08412             \textcolor{comment}{//We start reading from line 1.}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08413}08413             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 1; i < sts.Length; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08414}08414             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08415}08415                 list.Add(\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a616c510a1434e4cbcef43b0f10db3993}{StringToROI}}(sts[i]));}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08416}08416             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08417}08417             \textcolor{keywordflow}{return} list;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08418}08418         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08419}08419 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08431}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a20a36586911ac7de046cf4b1365e25a9}{08431}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{void} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a20a36586911ac7de046cf4b1365e25a9}{ExportROIFolder}}(\textcolor{keywordtype}{string} path, \textcolor{keywordtype}{string} filename)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08432}08432         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08433}08433             \textcolor{keywordflow}{if} (!\mbox{\hyperlink{class_bio_lib_1_1_bio_image_aced4701731fa1ab8467ca36935c9276e}{OMESupport}}())}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08434}08434                 \textcolor{keywordflow}{return};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08435}08435             \textcolor{keywordtype}{string}[] fs = Directory.GetFiles(path);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08436}08436             \textcolor{keywordtype}{int} i = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08437}08437             \textcolor{keywordflow}{foreach} (\textcolor{keywordtype}{string} f \textcolor{keywordflow}{in} fs)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08438}08438             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08439}08439                 List<ROI> annotations = OpenOMEROIs(f, 0);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08440}08440                 \textcolor{keywordtype}{string} ff = Path.GetFileNameWithoutExtension(f);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08441}08441                 \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a3630ab9b3a2e82e6d733b122d8035c89}{ExportROIsCSV}}(path + \textcolor{stringliteral}{"{}//"{}} + ff + \textcolor{stringliteral}{"{}-\/"{}} + i.ToString() + \textcolor{stringliteral}{"{}.csv"{}}, annotations);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08442}08442                 i++;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08443}08443             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08444}08444         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08445}08445 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08446}08446         \textcolor{keyword}{private} \textcolor{keyword}{static} \mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} bstats = \textcolor{keyword}{null};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08447}08447         \textcolor{keyword}{private} \textcolor{keyword}{static} \textcolor{keywordtype}{bool} update = \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08448}08448 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08460}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a33fd20434c7967adf57ef56ca1f959e0}{08460}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{void} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a33fd20434c7967adf57ef56ca1f959e0}{AutoThreshold}}(\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} b, \textcolor{keywordtype}{bool} updateImageStats)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08461}08461         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08462}08462             bstats = b;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08463}08463             Statistics statistics = \textcolor{keyword}{null};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08464}08464             \textcolor{keywordflow}{if} (b.bitsPerPixel > 8)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08465}08465                 statistics = \textcolor{keyword}{new} Statistics(\textcolor{keyword}{true});}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08466}08466             \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08467}08467                 statistics = \textcolor{keyword}{new} Statistics(\textcolor{keyword}{false});}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08468}08468             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < b.Buffers.Count; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08469}08469             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08470}08470                 \textcolor{keywordflow}{if} (b.Buffers[i].Stats == \textcolor{keyword}{null} || updateImageStats)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08471}08471                     b.Buffers[i].Stats = Statistics.FromBytes(b.Buffers[i]);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08472}08472                 \textcolor{keywordflow}{if} (b.Buffers[i].RGBChannelsCount == 1)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08473}08473                     statistics.AddStatistics(b.Buffers[i].Stats[0]);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08474}08474                 \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08475}08475                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08476}08476                     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} r = 0; r < b.Buffers[i].RGBChannelsCount; r++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08477}08477                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08478}08478                         statistics.AddStatistics(b.Buffers[i].Stats[r]);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08479}08479                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08480}08480                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08481}08481             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08482}08482 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08483}08483             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} c = 0; c < b.Channels.Count; c++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08484}08484             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08485}08485                 Statistics[] sts = \textcolor{keyword}{new} Statistics[b.Buffers[0].RGBChannelsCount];}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08486}08486                 \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < b.Buffers[0].RGBChannelsCount; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08487}08487                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08488}08488                     \textcolor{keywordflow}{if} (b.bitsPerPixel > 8)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08489}08489                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08490}08490                         sts[i] = \textcolor{keyword}{new} Statistics(\textcolor{keyword}{true});}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08491}08491                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08492}08492                     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08493}08493                         sts[i] = \textcolor{keyword}{new} Statistics(\textcolor{keyword}{false});}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08494}08494                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08495}08495                 \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} z = 0; z < b.SizeZ; z++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08496}08496                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08497}08497                     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} t = 0; t < b.SizeT; t++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08498}08498                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08499}08499                         \textcolor{keywordtype}{int} ind = b.Coords[z, c, t];}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08500}08500                         \textcolor{keywordflow}{if} (b.Buffers[ind].RGBChannelsCount == 1)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08501}08501                             sts[0].AddStatistics(b.Buffers[ind].Stats[0]);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08502}08502                         \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08503}08503                         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08504}08504                             sts[0].AddStatistics(b.Buffers[ind].Stats[0]);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08505}08505                             sts[1].AddStatistics(b.Buffers[ind].Stats[1]);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08506}08506                             sts[2].AddStatistics(b.Buffers[ind].Stats[2]);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08507}08507                             \textcolor{keywordflow}{if} (b.Buffers[ind].RGBChannelsCount == 4)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08508}08508                                 sts[3].AddStatistics(b.Buffers[ind].Stats[3]);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08509}08509                         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08510}08510                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08511}08511                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08512}08512                 \textcolor{keywordflow}{if} (b.RGBChannelCount == 1)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08513}08513                     sts[0].MeanHistogram();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08514}08514                 \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08515}08515                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08516}08516                     sts[0].MeanHistogram();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08517}08517                     sts[1].MeanHistogram();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08518}08518                     sts[2].MeanHistogram();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08519}08519                     \textcolor{keywordflow}{if} (b.Buffers[0].RGBChannelsCount == 4)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08520}08520                         sts[3].MeanHistogram();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08521}08521                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08522}08522                 b.Channels[c].stats = sts;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08523}08523             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08524}08524             statistics.MeanHistogram();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08525}08525             b.statistics = statistics;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08526}08526 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08527}08527         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08528}08528 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08533}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a2b70a64cf4a28cfb9a72417dfe8732d0}{08533}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{void} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a2b70a64cf4a28cfb9a72417dfe8732d0}{AutoThreshold}}()}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08534}08534         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08535}08535             \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a2b70a64cf4a28cfb9a72417dfe8732d0}{AutoThreshold}}(bstats, update);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08536}08536         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08537}08537 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08545}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_af34c9265b442f65661297c8d63c2bf6b}{08545}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{void} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_af34c9265b442f65661297c8d63c2bf6b}{AutoThresholdThread}}(\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} b)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08546}08546         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08547}08547             bstats = b;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08548}08548             Thread th = \textcolor{keyword}{new} Thread(\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a2b70a64cf4a28cfb9a72417dfe8732d0}{AutoThreshold}});}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08549}08549             th.Start();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08550}08550         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08551}08551 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08570}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_afe55cc7945c8d19b0b6bc05e0222faad}{08570}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{int} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_afe55cc7945c8d19b0b6bc05e0222faad}{FindFocus}}(\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} im, \textcolor{keywordtype}{int} Channel, \textcolor{keywordtype}{int} Time)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08571}08571         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08572}08572             \textcolor{keywordtype}{long} mf = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08573}08573             \textcolor{keywordtype}{int} fr = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08574}08574             List<double> dt = \textcolor{keyword}{new} List<double>();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08575}08575             ZCT c = \textcolor{keyword}{new} ZCT(0, 0, 0);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08576}08576             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < im.SizeZ; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08577}08577             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08578}08578                 \textcolor{keywordtype}{long} f = CalculateFocusQuality(im.Buffers[im.Coords[i, Channel, Time]]);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08579}08579                 dt.Add(f);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08580}08580                 \textcolor{keywordflow}{if} (f > mf)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08581}08581                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08582}08582                     mf = f;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08583}08583                     fr = im.Coords[i, Channel, Time];}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08584}08584                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08585}08585             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08586}08586             \textcolor{keywordflow}{return} fr;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08587}08587         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08588}08588 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08597}08597         \textcolor{keyword}{static} \textcolor{keywordtype}{long} CalculateFocusQuality(Bitmap b)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08598}08598         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08599}08599             \textcolor{keywordflow}{if} (b.RGBChannelsCount == 1)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08600}08600             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08601}08601                 \textcolor{keywordtype}{long} sum = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08602}08602                 \textcolor{keywordtype}{long} sumOfSquaresR = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08603}08603                 \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} y = 0; y < b.SizeY; y++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08604}08604                     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} x = 0; x < b.SizeX; x++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08605}08605                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08606}08606                         ColorS pixel = b.GetPixel(x, y);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08607}08607                         sum += pixel.R;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08608}08608                         sumOfSquaresR += pixel.R * pixel.R;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08609}08609                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08610}08610                 \textcolor{keywordflow}{return} sumOfSquaresR * b.SizeX * b.SizeY -\/ sum * sum;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08611}08611             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08612}08612             \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08613}08613             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08614}08614                 \textcolor{keywordtype}{long} sum = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08615}08615                 \textcolor{keywordtype}{long} sumOfSquares = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08616}08616                 \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} y = 0; y < b.SizeY; y++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08617}08617                     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} x = 0; x < b.SizeX; x++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08618}08618                     \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08619}08619                         ColorS pixel = b.GetPixel(x, y);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08620}08620                         \textcolor{keywordtype}{int} p = (pixel.R + pixel.G + pixel.B) / 3;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08621}08621                         sum += p;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08622}08622                         sumOfSquares += p * p;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08623}08623                     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08624}08624                 \textcolor{keywordflow}{return} sumOfSquares * b.SizeX * b.SizeY -\/ sum * sum;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08625}08625             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08626}08626         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08627}08627 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08628}08628 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08629}08629         \textcolor{keyword}{static} \textcolor{keywordtype}{string} openfile;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08630}08630         \textcolor{keyword}{static} \textcolor{keywordtype}{bool} omes, tab, add;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08631}08631         \textcolor{keyword}{static} \textcolor{keywordtype}{int} serie;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08632}08632         \textcolor{keyword}{static} \textcolor{keywordtype}{void} OpenThread()}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08633}08633         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08634}08634             \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a0b4596d690f6d8c9bc38580b15ce8de5}{OpenFile}}(openfile, serie, tab, add);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08635}08635         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08636}08636         \textcolor{keyword}{static} \textcolor{keywordtype}{string} savefile, saveid;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08637}08637         \textcolor{keyword}{static} \textcolor{keywordtype}{bool} some;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08638}08638         \textcolor{keyword}{static} \textcolor{keywordtype}{int} sserie;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08639}08639         \textcolor{keyword}{static} \textcolor{keywordtype}{void} SaveThread()}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08640}08640         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08641}08641             \textcolor{keywordflow}{if} (omes)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08642}08642                 \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a82f440ef5e46f4006148a51515f9df82}{SaveOME}}(savefile, saveid);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08643}08643             \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08644}08644                 \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a17a9dfbe050b1f6b8ea90e48d62bff0c}{SaveFile}}(savefile, saveid);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08645}08645         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08658}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a6a0e5f00b165c51a69bb7cf9b41777cb}{08658}}         \textcolor{keyword}{public} \textcolor{keyword}{static} async Task \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a6a0e5f00b165c51a69bb7cf9b41777cb}{SaveAsync}}(\textcolor{keywordtype}{string} file, \textcolor{keywordtype}{string} \textcolor{keywordtype}{id}, \textcolor{keywordtype}{int} serie, \textcolor{keywordtype}{bool} ome)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08659}08659         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08660}08660             savefile = file;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08661}08661             saveid = id;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08662}08662             some = ome;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08663}08663             await Task.Run(SaveThread);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08664}08664         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08665}08665 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08666}08666         \textcolor{keyword}{static} List<string> sts = \textcolor{keyword}{new} List<string>();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08667}08667         \textcolor{keyword}{static} \textcolor{keywordtype}{void} SaveSeriesThread()}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08668}08668         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08669}08669             \textcolor{keywordflow}{if} (omes)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08670}08670             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08671}08671                 \mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}}[] bms = \textcolor{keyword}{new} \mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}}[sts.Count];}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08672}08672                 \textcolor{keywordtype}{int} i = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08673}08673                 \textcolor{keywordflow}{foreach} (\textcolor{keywordtype}{string} st \textcolor{keywordflow}{in} sts)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08674}08674                 \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08675}08675                     bms[i] = Images.GetImage(st);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08676}08676                 \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08677}08677                 \mbox{\hyperlink{class_bio_lib_1_1_bio_image_afbc8fb1cb6b5c382b38610d0588d5a1a}{SaveOMESeries}}(bms, savefile, Planes);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08678}08678             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08679}08679             \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08680}08680                 \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a21bb8b9f3f4aa841e12af097d0f47b0a}{SaveSeries}}(sts.ToArray(), savefile);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08681}08681         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08691}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a93ff7c68159d5ab249ecd9c5581370af}{08691}}         \textcolor{keyword}{public} \textcolor{keyword}{static} async Task \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a93ff7c68159d5ab249ecd9c5581370af}{SaveSeriesAsync}}(\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}}[] imgs, \textcolor{keywordtype}{string} file, \textcolor{keywordtype}{bool} ome)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08692}08692         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08693}08693             sts.Clear();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08694}08694             \textcolor{keywordflow}{foreach} (\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} item \textcolor{keywordflow}{in} imgs)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08695}08695             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08696}08696                 sts.Add(item.ID);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08697}08697             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08698}08698             savefile = file;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08699}08699             some = ome;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08700}08700             await Task.Run(SaveSeriesThread);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08701}08701         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08702}08702         \textcolor{keyword}{static} Enums.ForeignTiffCompression comp;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08703}08703         \textcolor{keyword}{static} \textcolor{keywordtype}{int} compLev = 0;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08704}08704         \textcolor{keyword}{static} \mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}}[] bms;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08705}08705         \textcolor{keyword}{static} \textcolor{keywordtype}{void} SavePyramidalThread()}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08706}08706         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08707}08707             \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a8b4ee308c1ea43cb385cc1ecc8ff837e}{SaveOMEPyramidal}}(bms, savefile, comp, compLev);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08708}08708         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08722}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a7c783f52298019ead52e0b0d85bee4b0}{08722}}         \textcolor{keyword}{public} \textcolor{keyword}{static} async Task \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a7c783f52298019ead52e0b0d85bee4b0}{SavePyramidalAsync}}(\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}}[] imgs, \textcolor{keywordtype}{string} file, Enums.ForeignTiffCompression com, \textcolor{keywordtype}{int} compLevel)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08723}08723         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08724}08724             bms = imgs;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08725}08725             savefile = file;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08726}08726             comp = com;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08727}08727             compLev = compLevel;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08728}08728             await Task.Run(SavePyramidalThread);}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08729}08729         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08730}08730         \textcolor{keyword}{private} \textcolor{keyword}{static} List<string> openOMEfile = \textcolor{keyword}{new} List<string>();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08731}08731 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08736}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a25e327efa091538fe722d4de62a61e37}{08736}}         \textcolor{keyword}{public} \textcolor{keywordtype}{void} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a25e327efa091538fe722d4de62a61e37}{Dispose}}()}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08737}08737         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08738}08738             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < Buffers.Count; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08739}08739             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08740}08740                 Buffers[i].Dispose();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08741}08741             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08742}08742             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < Channels.Count; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08743}08743             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08744}08744                 Channels[i].Dispose();}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08745}08745             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08746}08746             Images.RemoveImage(\textcolor{keyword}{this});}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08747}08747         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08748}08748 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08756}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a46b27bfab51f5ddc76e51a6cf1d70983}{08756}}         \textcolor{keyword}{public} \textcolor{keyword}{override} \textcolor{keywordtype}{string} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a46b27bfab51f5ddc76e51a6cf1d70983}{ToString}}()}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08757}08757         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08758}08758             \textcolor{keywordflow}{return} Filename.ToString() + \textcolor{stringliteral}{"{}, ("{}} + Volume.Location.X + \textcolor{stringliteral}{"{}, "{}} + Volume.Location.Y + \textcolor{stringliteral}{"{}, "{}} + Volume.Location.Z + \textcolor{stringliteral}{"{})"{}};}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08759}08759         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08760}08760 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08761}08761         }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08773}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a64ee8b6f7d8f5d14cd31705cdb110c19}{08773}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a64ee8b6f7d8f5d14cd31705cdb110c19}{operator /}}(\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} a, \textcolor{keywordtype}{float} b)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08774}08774         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08775}08775             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < a.Buffers.Count; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08776}08776             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08777}08777                 a.Buffers[i] = a.Buffers[i] / b;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08778}08778             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08779}08779             \textcolor{keywordflow}{return} a;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08780}08780         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08781}08781 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08782}08782         }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08794}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a1f93a9cfa2e8f95647ece05a826f8cf5}{08794}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a1f93a9cfa2e8f95647ece05a826f8cf5}{operator +}}(\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} a, \textcolor{keywordtype}{float} b)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08795}08795         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08796}08796             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < a.Buffers.Count; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08797}08797             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08798}08798                 a.Buffers[i] = a.Buffers[i] + b;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08799}08799             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08800}08800             \textcolor{keywordflow}{return} a;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08801}08801         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08813}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_af649f6dc9490d2fcd8cfa51b55166b9a}{08813}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_af649f6dc9490d2fcd8cfa51b55166b9a}{operator -\/}}(\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} a, \textcolor{keywordtype}{float} b)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08814}08814         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08815}08815             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < a.Buffers.Count; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08816}08816             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08817}08817                 a.Buffers[i] = a.Buffers[i] -\/ b;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08818}08818             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08819}08819             \textcolor{keywordflow}{return} a;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08820}08820         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08821}08821 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08835}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_afbdce8df32c1359ef624a871914c7f4d}{08835}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a64ee8b6f7d8f5d14cd31705cdb110c19}{operator /}}(\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} a, ColorS b)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08836}08836         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08837}08837             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < a.Buffers.Count; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08838}08838             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08839}08839                 a.Buffers[i] = a.Buffers[i] / b;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08840}08840             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08841}08841             \textcolor{keywordflow}{return} a;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08842}08842         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08843}08843 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08857}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_acb065299b64687505b2e5a07a6d6d78a}{08857}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_acb065299b64687505b2e5a07a6d6d78a}{operator *}}(\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} a, ColorS b)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08858}08858         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08859}08859             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < a.Buffers.Count; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08860}08860             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08861}08861                 a.Buffers[i] = a.Buffers[i] * b;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08862}08862             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08863}08863             \textcolor{keywordflow}{return} a;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08864}08864         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08865}08865 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08879}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_a0869ed6d91aa56fe71e1692a90ec9698}{08879}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_a1f93a9cfa2e8f95647ece05a826f8cf5}{operator +}}(\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} a, ColorS b)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08880}08880         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08881}08881             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < a.Buffers.Count; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08882}08882             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08883}08883                 a.Buffers[i] = a.Buffers[i] + b;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08884}08884             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08885}08885             \textcolor{keywordflow}{return} a;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08886}08886         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08887}08887 }
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08900}\mbox{\hyperlink{class_bio_lib_1_1_bio_image_aeb1c0490bd76c5c882ca210af6a5fbfc}{08900}}         \textcolor{keyword}{public} \textcolor{keyword}{static} \mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} \mbox{\hyperlink{class_bio_lib_1_1_bio_image_af649f6dc9490d2fcd8cfa51b55166b9a}{operator -\/}}(\mbox{\hyperlink{class_bio_lib_1_1_bio_image}{BioImage}} a, ColorS b)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08901}08901         \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08902}08902             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < a.Buffers.Count; i++)}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08903}08903             \{}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08904}08904                 a.Buffers[i] = a.Buffers[i] -\/ b;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08905}08905             \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08906}08906             \textcolor{keywordflow}{return} a;}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08907}08907         \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08908}08908     \}}
\DoxyCodeLine{\Hypertarget{_bio_8cs_source_l08909}08909 \}}
