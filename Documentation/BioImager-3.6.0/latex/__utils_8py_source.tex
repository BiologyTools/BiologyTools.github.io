...
\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00001}\mbox{\hyperlink{namespacemicroscope_1_1__utils}{00001}} \textcolor{comment}{\#!/usr/bin/env python3}}
...
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00056}\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_only_triggers_once_on_software_mixin_aaf2cf32b19ad76ab483e073428409567}{00056}}     \textcolor{keyword}{def }\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_only_triggers_once_on_software_mixin_aaf2cf32b19ad76ab483e073428409567}{trigger\_type}}(self) -\/> microscope.TriggerType:}
...
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00060}\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_only_triggers_once_on_software_mixin_a22e5c04ca35b26f8dbabc3eb0e9fa0ea}{00060}}     \textcolor{keyword}{def }\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_only_triggers_once_on_software_mixin_a22e5c04ca35b26f8dbabc3eb0e9fa0ea}{trigger\_mode}}(self) -\/> microscope.TriggerMode:}
...
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00086}\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_only_triggers_bulb_on_software_mixin_a26c0ddd5bed88e5d04f95422a73f6325}{00086}}     \textcolor{keyword}{def }\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_only_triggers_bulb_on_software_mixin_a26c0ddd5bed88e5d04f95422a73f6325}{trigger\_type}}(self) -\/> microscope.TriggerType:}
...
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00090}\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_only_triggers_bulb_on_software_mixin_ae7e749cf68669b6a4df28a4c8c5c2b51}{00090}}     \textcolor{keyword}{def }\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_only_triggers_bulb_on_software_mixin_ae7e749cf68669b6a4df28a4c8c5c2b51}{trigger\_mode}}(self) -\/> microscope.TriggerMode:}
...
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00114}\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_aaadd42fc1bbfcce4b2d12b529e6cd206}{00114}}     \textcolor{keyword}{def }\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_aaadd42fc1bbfcce4b2d12b529e6cd206}{\_\_init\_\_}}(self, serial: serial.Serial) -\/> \textcolor{keywordtype}{None}:}
...
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00119}\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_a0327c538a5acee66ec083c01b3752017}{00119}}     \textcolor{keyword}{def }\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_a0327c538a5acee66ec083c01b3752017}{lock}}(self) -\/> threading.RLock:}
...
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00122}\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_aff22c8fcd9422bc825633f2e85a4a7d8}{00122}}     \textcolor{keyword}{def }\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_aff22c8fcd9422bc825633f2e85a4a7d8}{readline}}(self) -\/> bytes:}
...
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00124}00124             \textcolor{keywordflow}{return} self.\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_a13211c14a89bc7ea7b602c979621f54f}{\_serial}}.\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_aff22c8fcd9422bc825633f2e85a4a7d8}{readline}}()}
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00125}00125 }
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00126}\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_acf705bb9c18b9ca3b5b0ee092affffaf}{00126}}     \textcolor{keyword}{def }\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_acf705bb9c18b9ca3b5b0ee092affffaf}{readlines}}(self, hint: int = -\/1) -\/> typing.List[bytes]:}
...
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00128}00128             \textcolor{keywordflow}{return} self.\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_a13211c14a89bc7ea7b602c979621f54f}{\_serial}}.\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_acf705bb9c18b9ca3b5b0ee092affffaf}{readlines}}(hint)}
...
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00132}\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_aca66151c41634c3ed1144baa27b94270}{00132}}     \textcolor{keyword}{def }\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_aca66151c41634c3ed1144baa27b94270}{read\_until}}(}
...
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00136}00136             \textcolor{keywordflow}{return} self.\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_a13211c14a89bc7ea7b602c979621f54f}{\_serial}}.\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_aca66151c41634c3ed1144baa27b94270}{read\_until}}(terminator, size=size)}
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00137}00137 }
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00138}\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_a720faa60599de312bf74c84f790318c3}{00138}}     \textcolor{keyword}{def }\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_a720faa60599de312bf74c84f790318c3}{write}}(self, data: bytes) -\/> int:}
...
\DoxyCodeLine{\Hypertarget{__utils_8py_source_l00140}00140             \textcolor{keywordflow}{return} self.\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_a13211c14a89bc7ea7b602c979621f54f}{\_serial}}.\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial_a720faa60599de312bf74c84f790318c3}{write}}(data)}
