...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00052}00052 }
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00053}00053         \textcolor{keyword}{def }handle(self, command):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00054}00054             \textcolor{keywordflow}{if} command.startswith(b\textcolor{stringliteral}{"{}echo "{}}):}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00061}00061     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00062}00062         self.serial = \mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_serial_mock_1_1_serial}{TestSerialMock.Serial}}()}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00063}00063         patcher = unittest.mock.patch.object(}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00064}00064             \mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_serial_mock_1_1_serial}{TestSerialMock.Serial}}, \textcolor{stringliteral}{"{}handle"{}}, wraps=self.serial.handle}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00067}00067         self.mock = patcher.start()}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00068}00068 }
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00069}00069     \textcolor{keyword}{def }test\_simple\_commands(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00070}00070         self.serial.write(b\textcolor{stringliteral}{"{}foo\(\backslash\)r\(\backslash\)n"{}})}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00071}00071         self.mock.assert\_called\_once\_with(b\textcolor{stringliteral}{"{}foo"{}})}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00072}00072 }
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00073}00073     \textcolor{keyword}{def }test\_partial\_commands(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00074}00074         self.serial.write(b\textcolor{stringliteral}{"{}fo"{}})}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00075}00075         self.serial.write(b\textcolor{stringliteral}{"{}o"{}})}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00076}00076         self.serial.write(b\textcolor{stringliteral}{"{}\(\backslash\)r\(\backslash\)n"{}})}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00077}00077         self.serial.handle.assert\_called\_once\_with(b\textcolor{stringliteral}{"{}foo"{}})}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00078}00078 }
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00079}00079     \textcolor{keyword}{def }test\_multiple\_commands(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00080}00080         self.serial.write(b\textcolor{stringliteral}{"{}foo\(\backslash\)r\(\backslash\)nbar\(\backslash\)r\(\backslash\)n"{}})}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00082}00082         self.assertEqual(self.serial.handle.mock\_calls, calls)}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00083}00083 }
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00084}00084     \textcolor{keyword}{def }test\_unix\_eol(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00085}00085         self.serial.eol = b\textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00086}00086         self.serial.write(b\textcolor{stringliteral}{"{}foo\(\backslash\)nbar\(\backslash\)n"{}})}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00088}00088         self.assertEqual(self.serial.handle.mock\_calls, calls)}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00089}00089 }
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00090}00090     \textcolor{keyword}{def }test\_write(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00091}00091         self.serial.write(b\textcolor{stringliteral}{"{}echo qux\(\backslash\)r\(\backslash\)n"{}})}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00092}00092         self.assertEqual(self.serial.readline(), b\textcolor{stringliteral}{"{}qux\(\backslash\)r\(\backslash\)n"{}})}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00112}00112     \textcolor{keyword}{def }test\_enable\_and\_disable(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00113}00113         \textcolor{comment}{\# TODO: we need to define what happens when enable is called}}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00149}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_serial_device_tests}{00149}}     \textcolor{keyword}{def }test\_connection\_defaults(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00150}00150         self.assertEqual(self.device.connection.baudrate, self.fake.baudrate)}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00177}00177 \textcolor{stringliteral}{    }\textcolor{keyword}{def }assertEqualMW(self, first, second, msg=None):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00178}00178         \textcolor{comment}{\# We could be smarter, but rounding the values should be}}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00182}00182     \textcolor{keyword}{def }test\_get\_is\_on(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00183}00183         self.assertEqual(self.device.connection.light, self.device.get\_is\_on())}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00189}00189     \textcolor{keyword}{def }test\_off\_after\_constructor(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00190}00190         \textcolor{comment}{\# Some lasers, such as our Coherent Sapphire emit laser}}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00196}00196     \textcolor{keyword}{def }test\_turning\_on\_and\_off(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00197}00197         self.device.enable()}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00202}00202     \textcolor{keyword}{def }test\_shutdown(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00203}00203         self.device.enable()}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00207}00207     \textcolor{keyword}{def }test\_power\_when\_off(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00208}00208         self.device.disable()}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00212}00212     \textcolor{keyword}{def }test\_setting\_power(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00213}00213         self.device.enable()}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00227}00227     \textcolor{keyword}{def }test\_setting\_power\_outside\_limit(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00228}00228         self.device.enable()}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00238}00238     \textcolor{keyword}{def }test\_status(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00239}00239         status = self.device.get\_status()}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00254}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_filter_wheel_tests}{00254}}     \textcolor{keyword}{def }test\_get\_and\_set\_position(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00255}00255         self.assertEqual(self.device.position, 0)}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00260}00260     \textcolor{keyword}{def }test\_set\_position\_to\_negative(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00261}00261         \textcolor{keyword}{with} self.assertRaisesRegex(Exception, \textcolor{stringliteral}{"{}can't move to position"{}}):}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00264}00264     \textcolor{keyword}{def }test\_set\_position\_above\_limit(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00265}00265         \textcolor{keyword}{with} self.assertRaisesRegex(Exception, \textcolor{stringliteral}{"{}can't move to position"{}}):}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00278}00278 \textcolor{stringliteral}{    }\textcolor{keyword}{def }assertCurrentPattern(self, expected\_pattern, msg="{}"{}):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00279}00279         numpy.testing.assert\_array\_equal(}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00283}00283     \textcolor{keyword}{def }test\_get\_number\_of\_actuators(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00284}00284         self.assertIsInstance(self.device.n\_actuators, int)}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00288}00288     \textcolor{keyword}{def }test\_applying\_pattern(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00289}00289         pattern = numpy.full((self.planned\_n\_actuators,), 0.2)}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00293}00293     \textcolor{keyword}{def }test\_out\_of\_range\_pattern(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00294}00294         \textcolor{comment}{\# While we expect values in the [0 1] range, we should not}}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00302}00302     \textcolor{keyword}{def }test\_software\_triggering(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00303}00303         n\_patterns = 5}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00310}00310     \textcolor{keyword}{def }test\_validate\_pattern\_too\_long(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00311}00311         patterns = numpy.zeros((self.planned\_n\_actuators + 1))}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00315}00315     \textcolor{keyword}{def }test\_validate\_pattern\_swapped\_dimensions(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00316}00316         patterns = numpy.zeros((self.planned\_n\_actuators, 1))}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00320}00320     \textcolor{keyword}{def }test\_validate\_pattern\_with\_extra\_dimension(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00321}00321         patterns = numpy.zeros((2, 1, self.planned\_n\_actuators))}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00337}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_light_source}{00337}}     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00338}00338         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_light_source_a609e64d365a2776b28662f8d3deae50c}{device}} = \mbox{\hyperlink{classmicroscope_1_1simulators_1_1_simulated_light_source}{simulators.SimulatedLightSource}}()}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00339}00339 }
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00342}00342         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_light_source_a53d0224bd6524572b4ec36dec545808c}{fake}}.default\_power = self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_light_source_a53d0224bd6524572b4ec36dec545808c}{fake}}.\_set\_point}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00346}00346     \textcolor{keyword}{def }test\_get\_is\_on(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00347}00347         \textcolor{comment}{\# TODO: this test assumes the connection property to be the}}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00355}00355     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00356}00356         \textcolor{keyword}{from} \mbox{\hyperlink{namespacemicroscope_1_1lights_1_1sapphire}{microscope.lights.sapphire}} \textcolor{keyword}{import} SapphireLaser}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00364}00364         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_coherent_sapphire_laser_adcdb2b6478c0f1212a42bbf9940b0284}{device}}.initialize()}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00367}00367 }
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00370}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_cobolt_laser}{00370}}     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00371}00371         \textcolor{keyword}{from} \mbox{\hyperlink{namespacemicroscope_1_1lights_1_1cobolt}{microscope.lights.cobolt}} \textcolor{keyword}{import} CoboltLaser}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00378}00378         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_cobolt_laser_a392705bec75948df9046ad9d1c6fd48f}{device}}.initialize()}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00381}00381 }
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00386}00386     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00387}00387         \textcolor{keyword}{from} \mbox{\hyperlink{namespacemicroscope_1_1lights_1_1deepstar}{microscope.lights.deepstar}} \textcolor{keyword}{import} DeepstarLaser}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00395}00395         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_omicron_deepstar_laser_ade21b24463a164c011f9db0e8bda5ba9}{device}}.initialize()}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00398}00398 }
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00399}00399     \textcolor{keyword}{def }test\_weird\_initial\_state(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00400}00400         \textcolor{comment}{\# The initial state of the laser may not be ideal to actual}}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00419}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_camera}{00419}}     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00420}00420         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_camera_a6d08a5851481d95da50ae3e5a0baeca6}{device}} = \mbox{\hyperlink{classmicroscope_1_1simulators_1_1_simulated_camera}{simulators.SimulatedCamera}}()}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00421}00421 }
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00424}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_image_generator}{00424}}     \textcolor{keyword}{def }test\_non\_square\_patterns\_shape(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00425}00425         \textcolor{comment}{\# TODO: we should also be testing this via the camera but the}}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00442}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_controller}{00442}}     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00443}00443         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_controller_a597c29aa67f077139da6ea0d4b46ef21}{laser}} = \mbox{\hyperlink{classmicroscope_1_1simulators_1_1_simulated_light_source}{simulators.SimulatedLightSource}}()}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00445}00445         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_controller_ac7ee529d20b2f60eca4aeae73b8333ec}{device}} = \mbox{\hyperlink{classmicroscope_1_1simulators_1_1_simulated_controller}{simulators.SimulatedController}}(}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00446}00446             \{\textcolor{stringliteral}{"{}laser"{}}: self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_controller_a597c29aa67f077139da6ea0d4b46ef21}{laser}}, \textcolor{stringliteral}{"{}filterwheel"{}}: self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_controller_a00449a5bc4c2f6464b111d1ca526a5f7}{filterwheel}}\}}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00449}00449     \textcolor{keyword}{def }test\_device\_names(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00450}00450         self.assertSetEqual(}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00454}00454     \textcolor{keyword}{def }test\_control\_filterwheel(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00455}00455         self.assertEqual(self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_controller_ac7ee529d20b2f60eca4aeae73b8333ec}{device}}.devices[\textcolor{stringliteral}{"{}filterwheel"{}}].position, 0)}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00459}00459     \textcolor{keyword}{def }test\_control\_laser(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00460}00460         self.assertEqual(self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_controller_ac7ee529d20b2f60eca4aeae73b8333ec}{device}}.devices[\textcolor{stringliteral}{"{}laser"{}}].power, 0.0)}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00467}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_empty_dummy_filter_wheel}{00467}}     \textcolor{keyword}{def }test\_zero\_positions(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00468}00468         \textcolor{keyword}{with} self.assertRaisesRegex(}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00475}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_one_position_filter_wheel}{00475}}     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00476}00476         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_one_position_filter_wheel_a0561aa42eaa9d9ed8098b6b38d35c0be}{device}} = \mbox{\hyperlink{classmicroscope_1_1simulators_1_1_simulated_filter_wheel}{simulators.SimulatedFilterWheel}}(positions=1)}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00477}00477 }
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00480}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_six_position_filter_wheel}{00480}}     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00481}00481         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_six_position_filter_wheel_a097173b22dd9550c64f9cf0f36dd00b5}{device}} = \mbox{\hyperlink{classmicroscope_1_1simulators_1_1_simulated_filter_wheel}{simulators.SimulatedFilterWheel}}(positions=6)}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00482}00482 }
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00485}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_deformable_mirror}{00485}}     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00486}00486         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_deformable_mirror_a3084cc0e8eff7e2c3fccf3da71f41d0f}{planned\_n\_actuators}} = 86}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00488}00488             self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_deformable_mirror_a3084cc0e8eff7e2c3fccf3da71f41d0f}{planned\_n\_actuators}}}
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00491}00491 }
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00494}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_s_l_m}{00494}}     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00495}00495         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_s_l_m_acfdc8d0af68ee83b4943ffd7b7a074b1}{device}} = dummies.DummySLM()}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00496}00496 }
...
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00499}\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_d_s_p}{00499}}     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00500}00500         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__devices_1_1_test_dummy_d_s_p_a29f6468b558c15fa5799731f91edd508}{device}} = dummies.DummyDSP()}
\DoxyCodeLine{\Hypertarget{test__devices_8py_source_l00501}00501 }
