...
\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00001}00001 \textcolor{comment}{\#!/usr/bin/env python3}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00002}00002 }
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00003}00003 \textcolor{comment}{\#\# Copyright (C) 2020 David Miguel Susano Pinto <carandraug@gmail.com>}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00004}00004 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00005}00005 \textcolor{comment}{\#\# This file is part of Microscope.}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00006}00006 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00007}00007 \textcolor{comment}{\#\# Microscope is free software: you can redistribute it and/or modify}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00008}00008 \textcolor{comment}{\#\# it under the terms of the GNU General Public License as published by}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00009}00009 \textcolor{comment}{\#\# the Free Software Foundation, either version 3 of the License, or}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00010}00010 \textcolor{comment}{\#\# (at your option) any later version.}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00011}00011 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00012}00012 \textcolor{comment}{\#\# Microscope is distributed in the hope that it will be useful,}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00013}00013 \textcolor{comment}{\#\# but WITHOUT ANY WARRANTY; without even the implied warranty of}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00014}00014 \textcolor{comment}{\#\# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00015}00015 \textcolor{comment}{\#\# GNU General Public License for more details.}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00016}00016 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00017}00017 \textcolor{comment}{\#\# You should have received a copy of the GNU General Public License}}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00018}00018 \textcolor{comment}{\#\# along with Microscope.  If not, see <http://www.gnu.org/licenses/>.}}
...
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00039}00039     \textcolor{keyword}{def }\_\_init\_\_(self, serial: microscope.\mbox{\hyperlink{classmicroscope_1_1__utils_1_1_shared_serial}{\_utils.SharedSerial}}) -\/> \textcolor{keywordtype}{None}:}
...
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00091}00091     \textcolor{keyword}{def }\_\_init\_\_(self, connection: \_CoolLEDConnection, name: str) -\/> \textcolor{keywordtype}{None}:}
...
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00121}00121     \textcolor{keyword}{def }get\_selected\_state(self) -\/> str:}
...
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00136}00136     \textcolor{keyword}{def }\_\_init\_\_(}
...
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00139}00139         super().\_\_init\_\_(**kwargs)}
...
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00190}00190     \textcolor{keyword}{def }trigger\_type(self) -\/> microscope.TriggerType:}
...
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00207}00207     \textcolor{keyword}{def }trigger\_mode(self) -\/> microscope.TriggerMode:}
...
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00293}00293 \textcolor{stringliteral}{    }\textcolor{keyword}{def }\_\_init\_\_(self, port: str, **kwargs) -\/> \textcolor{keywordtype}{None}:}
\DoxyCodeLine{\Hypertarget{coolled_8py_source_l00294}00294         super().\_\_init\_\_(**kwargs)}
