...
\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00001}00001 \textcolor{comment}{\#!/usr/bin/env python3}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00002}00002 }
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00003}00003 \textcolor{comment}{\#\# Copyright (C) 2020 David Miguel Susano Pinto <carandraug@gmail.com>}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00004}00004 \textcolor{comment}{\#\# Copyright (C) 2020 Mick Phillips <mick.phillips@gmail.com>}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00005}00005 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00006}00006 \textcolor{comment}{\#\# This file is part of Microscope.}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00007}00007 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00008}00008 \textcolor{comment}{\#\# Microscope is free software: you can redistribute it and/or modify}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00009}00009 \textcolor{comment}{\#\# it under the terms of the GNU General Public License as published by}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00010}00010 \textcolor{comment}{\#\# the Free Software Foundation, either version 3 of the License, or}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00011}00011 \textcolor{comment}{\#\# (at your option) any later version.}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00012}00012 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00013}00013 \textcolor{comment}{\#\# Microscope is distributed in the hope that it will be useful,}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00014}00014 \textcolor{comment}{\#\# but WITHOUT ANY WARRANTY; without even the implied warranty of}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00015}00015 \textcolor{comment}{\#\# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00016}00016 \textcolor{comment}{\#\# GNU General Public License for more details.}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00017}00017 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00018}00018 \textcolor{comment}{\#\# You should have received a copy of the GNU General Public License}}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00019}00019 \textcolor{comment}{\#\# along with Microscope.  If not, see <http://www.gnu.org/licenses/>.}}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00049}00049 DTYPES = \{}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00099}00099 \textcolor{stringliteral}{    }\textcolor{keyword}{def }\_\_init\_\_(}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00108}00108         self.\mbox{\hyperlink{classmicroscope_1_1abc_1_1___setting_a354652a39947995ab02aeaf646820e45}{name}} = name}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00116}00116         self.\mbox{\hyperlink{classmicroscope_1_1abc_1_1___setting_a155191f21fe690c1672464a8db3cff4c}{dtype}} = dtype}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00143}00143     \textcolor{keyword}{def }describe(self):}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00151}00151     \textcolor{keyword}{def }get(self):}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00161}00161     \textcolor{keyword}{def }readonly(self) -\/> bool:}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00173}00173     \textcolor{keyword}{def }values(self):}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00214}00214 \textcolor{stringliteral}{    }\textcolor{keyword}{def }\_\_init\_\_(self, index: int, **kwargs) -\/> \textcolor{keywordtype}{None}:}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00215}00215         super().\_\_init\_\_(**kwargs)}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00238}00238     \textcolor{keyword}{def }trigger\_mode(self) -\/> microscope.TriggerMode:}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00243}00243     \textcolor{keyword}{def }trigger\_type(self) -\/> microscope.TriggerType:}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00288}00288     \textcolor{keyword}{def }\_\_init\_\_(self) -\/> None:}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00289}00289         self.\mbox{\hyperlink{classmicroscope_1_1abc_1_1_device_a640a17ad1c1008f954cd4a1dba9b54fc}{enabled}} = \textcolor{keyword}{False}}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00292}00292     \textcolor{keyword}{def }\_\_del\_\_(self) -\/> None:}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00295}00295     \textcolor{keyword}{def }get\_is\_enabled(self) -\/> bool:}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00524}00524 \textcolor{keyword}{def }keep\_acquiring(func):}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00531}00531             self.\mbox{\hyperlink{classmicroscope_1_1abc_1_1_device_a5ab587adac09d57797a205e4f4f48313}{\_do\_enable}}()}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00580}00580     \textcolor{keyword}{def }\_\_del\_\_(self):}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00582}00582         super().\_\_del\_\_()}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00585}00585     set\_setting = keep\_acquiring(Device.set\_setting)}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00605}00605             self.\mbox{\hyperlink{classmicroscope_1_1abc_1_1_device_a640a17ad1c1008f954cd4a1dba9b54fc}{enabled}}\mbox{\hyperlink{classmicroscope_1_1abc_1_1_data_device_aeaadc6353820e217ea6fb4e063e53a53}{enabled}} = \textcolor{keyword}{False}}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l00827}00827 \textcolor{stringliteral}{    ALLOWED\_TRANSFORMS = [p }\textcolor{keywordflow}{for} p \textcolor{keywordflow}{in} itertools.product(*3 * [[\textcolor{keyword}{False}, \textcolor{keyword}{True}]])]}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01007}01007 \textcolor{stringliteral}{    }\textcolor{keyword}{def }\_\_init\_\_(self, **kwargs):}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01008}01008         super().\_\_init\_\_(**kwargs)}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01013}01013         self.\mbox{\hyperlink{classmicroscope_1_1abc_1_1_serial_device_mixin_a9e3ba09d83f3a9e56cae14813c6423ea}{connection}} = \textcolor{keywordtype}{None}  \textcolor{comment}{\# serial.Serial (to be constructed by child)}}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01076}01076     \textcolor{keyword}{def }\_\_init\_\_(self, **kwargs) -\/> None:}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01077}01077         super().\_\_init\_\_(**kwargs)}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01083}01083     \textcolor{keyword}{def }n\_actuators(self) -\/> int:}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01201}01201     \textcolor{keyword}{def }\_\_init\_\_(self, **kwargs):}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01202}01202         super().\_\_init\_\_(**kwargs)}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01264}01264 \textcolor{stringliteral}{    }\textcolor{keyword}{def }\_\_init\_\_(self, positions: int, **kwargs) -\/> \textcolor{keywordtype}{None}:}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01265}01265         super().\_\_init\_\_(**kwargs)}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01288}\mbox{\hyperlink{classmicroscope_1_1abc_1_1_filter_wheel_a9ef5f7efd19fd202a51b1b70b12aeff0}{01288}}     \textcolor{keyword}{def }position(self) -\/> int:}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01293}01293     \textcolor{keyword}{def }position(self, new\_position: int) -\/> \textcolor{keywordtype}{None}:}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01315}01315     \textcolor{keyword}{def }get\_position(self) -\/> int:}
...
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01318}01318     \textcolor{keyword}{def }set\_position(self, position: int) -\/> \textcolor{keywordtype}{None}:}
\DoxyCodeLine{\Hypertarget{abc_8py_source_l01319}01319         self.\mbox{\hyperlink{classmicroscope_1_1abc_1_1_filter_wheel_a8036d13effbd943a8727a87d7b72cc3d}{position}}\mbox{\hyperlink{classmicroscope_1_1abc_1_1_filter_wheel_a9ef5f7efd19fd202a51b1b70b12aeff0}{position}}\mbox{\hyperlink{classmicroscope_1_1abc_1_1_filter_wheel_acc0885ae9f24abfde54045f3920783e3}{position}} = position}
