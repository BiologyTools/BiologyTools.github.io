...
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00003}00003 \textcolor{comment}{\#\# Copyright (C) 2020 David Miguel Susano Pinto <carandraug@gmail.com>}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00004}00004 \textcolor{comment}{\#\# Copyright (C) 2020 Ian Dobbie <ian.dobbie@bioch.ox.ac.uk>}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00005}00005 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00006}00006 \textcolor{comment}{\#\# This file is part of Microscope.}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00007}00007 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00008}00008 \textcolor{comment}{\#\# Microscope is free software: you can redistribute it and/or modify}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00009}00009 \textcolor{comment}{\#\# it under the terms of the GNU General Public License as published by}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00010}00010 \textcolor{comment}{\#\# the Free Software Foundation, either version 3 of the License, or}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00011}00011 \textcolor{comment}{\#\# (at your option) any later version.}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00012}00012 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00013}00013 \textcolor{comment}{\#\# Microscope is distributed in the hope that it will be useful,}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00014}00014 \textcolor{comment}{\#\# but WITHOUT ANY WARRANTY; without even the implied warranty of}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00015}00015 \textcolor{comment}{\#\# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00016}00016 \textcolor{comment}{\#\# GNU General Public License for more details.}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00017}00017 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00018}00018 \textcolor{comment}{\#\# You should have received a copy of the GNU General Public License}}
\DoxyCodeLine{\Hypertarget{stage__aware__camera_8py_source_l00019}00019 \textcolor{comment}{\#\# along with Microscope.  If not, see <http://www.gnu.org/licenses/>.}}
