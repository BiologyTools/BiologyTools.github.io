...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00048}00048 \textcolor{stringliteral}{    }\textcolor{keyword}{def }\_\_init\_\_(self, *args, **kwargs):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00049}00049         super().\_\_init\_\_(*args, **kwargs)}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00051}00051         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_serial_mock_a56031fdb4c018be80bd0057911331888}{out\_buffer}} = io.BytesIO()}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00052}00052 }
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00056}00056         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_serial_mock_a5df6cdda888afeffaf28ab48888bc68d}{out\_parsed\_bytes}} = 0}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00057}00057 }
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00060}00060 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00061}00061     \textcolor{keyword}{def }open(self):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00062}00062         \textcolor{keywordflow}{pass}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00063}00063 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00064}00064     \textcolor{keyword}{def }close(self):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00065}00065         self.in\_buffer.close()}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00066}00066         self.out\_buffer.close()}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00067}00067 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00068}00068     \textcolor{keyword}{def }handle(self, command):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00069}00069         \textcolor{keywordflow}{raise} NotImplementedError(\textcolor{stringliteral}{"{}sub classes need to implement handle()"{}})}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00070}00070 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00071}00071     \textcolor{keyword}{def }write(self, data):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00072}00072         self.out\_buffer.write(data)}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00073}00073         self.out\_pending\_bytes += len(data)}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00074}00074 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00075}00075         \textcolor{keywordflow}{if} self.out\_pending\_bytes > len(data):}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00077}00077             self.out\_buffer.seek(-\/self.out\_pending\_bytes, 2)}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00078}00078             data = self.out\_buffer.read(self.out\_pending\_bytes)}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00081}00081             self.handle(msg)}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00082}00082             self.out\_pending\_bytes -\/= len(msg) + len(self.eol)}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00087}00087         self.in\_buffer.seek(self.in\_read\_bytes)}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00088}00088         msg = reader(*args, **kwargs)}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00089}00089         self.in\_read\_bytes += len(msg)}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00092}00092     \textcolor{keyword}{def }read(self, size=1):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00093}00093         \textcolor{keywordflow}{return} self.\_readx\_wrapper(self.in\_buffer.read, size)}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00094}00094 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00095}00095     \textcolor{keyword}{def }readline(self, size=-\/1):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00096}00096         \textcolor{keywordflow}{return} self.\_readx\_wrapper(self.in\_buffer.readline, size)}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00097}00097 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00098}00098     \textcolor{keyword}{def }reset\_input\_buffer(self):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00099}00099         self.in\_read\_bytes = self.in\_buffer.getbuffer().nbytes}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00100}00100         self.in\_buffer.seek(0, 2)}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00101}00101 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00102}00102     \textcolor{keyword}{def }reset\_output\_buffer(self):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00103}00103         \textcolor{keywordflow}{pass}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00121}00121 }
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00124}00124     parity = serial.PARITY\_NONE}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00125}00125     bytesize = serial.EIGHTBITS}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00126}00126     stopbits = serial.STOPBITS\_ONE}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00127}00127     rtscts = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00128}00128     dsrdtr = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00129}00129 }
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00132}00132     min\_power = 20.0}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00133}00133     max\_power = 220.0}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00134}00134 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00135}00135     \textcolor{keyword}{def }\_\_init\_\_(self, *args, **kwargs):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00136}00136         super().\_\_init\_\_(*args, **kwargs)}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00139}00139         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_coherent_sapphire_laser_mock_a12fedc0b5252ec3c8168da35b696c110}{status}} = \textcolor{stringliteral}{"{}laser ready"{}}  \textcolor{comment}{\# Laser ready, status code 5}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00140}00140         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_coherent_sapphire_laser_mock_ab0dde8063da01e3e7076a7114aef404d}{light}} = \textcolor{keyword}{True}  \textcolor{comment}{\# Light Servo}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00141}00141         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_coherent_sapphire_laser_mock_afa421b278cb47d11a940bcbbe5aa9fce}{tec}} = \textcolor{keyword}{True}  \textcolor{comment}{\# TEC (Thermo-\/Electric Cooler) Servo}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00142}00142         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_coherent_sapphire_laser_mock_af5edfd4825b79f26205a676f21130b5b}{echo}} = \textcolor{keyword}{True}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00143}00143         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_coherent_sapphire_laser_mock_a081e2c903943d161e555bc28dd061389}{prompt}} = \textcolor{keyword}{True}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00144}00144         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_coherent_sapphire_laser_mock_ac0c09803ab3d38837fbdef4137f13c49}{power}} = CoherentSapphireLaserMock.default\_power}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00145}00145 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00146}00146     \textcolor{keyword}{def }write(self, data):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00147}00147         \textcolor{comment}{\# Echo as soon as we get data, do not wait for an EOL.  Also,}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00151}00151             self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_serial_mock_ad8be9c16f92ff7271670be312647d4a7}{in\_buffer}}.write(data)}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00154}00154             self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_serial_mock_ad8be9c16f92ff7271670be312647d4a7}{in\_buffer}}.write(self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_coherent_sapphire_laser_mock_a26f5a887764fef6823fa0ef0c95e632d}{eol}} * data.count(self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_coherent_sapphire_laser_mock_a26f5a887764fef6823fa0ef0c95e632d}{eol}}))}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00155}00155         \textcolor{keywordflow}{return} super().write(data)}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00156}00156 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00157}00157     \textcolor{keyword}{def }handle(self, command):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00158}00158         \textcolor{comment}{\# Operator's manual mentions all commands in uppercase.}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00311}00311             self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_serial_mock_ad8be9c16f92ff7271670be312647d4a7}{in\_buffer}}.write(b\textcolor{stringliteral}{"{}Sapphire:0-\/> "{}})}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00319}00319 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00320}00320     baudrate = 115200}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00321}00321     parity = serial.PARITY\_NONE}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00322}00322     bytesize = serial.EIGHTBITS}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00323}00323     stopbits = serial.STOPBITS\_ONE}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00324}00324     rtscts = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00325}00325     dsrdtr = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00326}00326 }
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00329}00329     min\_power = 0.0}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00330}00330     max\_power = 600.0}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00331}00331 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00332}00332     \textcolor{keyword}{def }\_\_init\_\_(self, *args, **kwargs):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00333}00333         super().\_\_init\_\_(*args, **kwargs)}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00336}00336         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_cobolt_laser_mock_a3d46aafaec307c575a6c740e84ea5863}{light}} = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00337}00337 }
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00339}00339 }
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00341}00341         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_cobolt_laser_mock_a3d5200cb9c5e9e5a0358baa04c8aa01c}{direct\_control}} = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00342}00342 }
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00344}00344 }
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00346}00346 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00347}00347     \textcolor{keyword}{def }handle(self, command):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00348}00348         \textcolor{comment}{\# Leading and trailing whitespace is ignored.}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00470}00470         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1mock__devices_1_1_serial_mock_ad8be9c16f92ff7271670be312647d4a7}{in\_buffer}}.write(answer + b\textcolor{stringliteral}{"{}\(\backslash\)r\(\backslash\)n"{}})}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00477}00477 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00478}00478     baudrate = 9600}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00479}00479     parity = serial.PARITY\_NONE}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00480}00480     bytesize = serial.EIGHTBITS}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00481}00481     stopbits = serial.STOPBITS\_ONE}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00482}00482     rtscts = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00483}00483     dsrdtr = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00484}00484 }
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00487}00487     min\_power = 0.0}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00488}00488     max\_power = 200.0}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00489}00489 }
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00492}00492         S1 = 1  \textcolor{comment}{\# Standby state or Laser OFF state}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00493}00493         S2 = 2  \textcolor{comment}{\# Laser ON state}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00494}00494 }
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00497}00497         bias = 2}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00498}00498         modulated = 3}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00499}00499         deepstar = 4}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00500}00500 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00501}00501     command2mode = \{}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00502}00502         b\textcolor{stringliteral}{"{}L0"{}}: Mode.blackout,}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00509}00509         Mode.blackout: b\textcolor{stringliteral}{"{}L0"{}},  \textcolor{comment}{\# always L0, even if BLK was used}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00515}00515     \textcolor{keyword}{def }\_\_init\_\_(self, *args, **kwargs):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00516}00516         super().\_\_init\_\_(*args, **kwargs)}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00517}00517 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00518}00518         self.power = self.default\_power}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00519}00519 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00520}00520         self.state = self.State.S1  \textcolor{comment}{\# default dependent on 'ASx' command}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00521}00521         self.mode = self.Mode.blackout}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00522}00522 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00523}00523         self.internal\_peak\_power = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00524}00524         self.analog2digital = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00525}00525         self.bias\_modulation = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00526}00526         self.digital\_modulation = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00527}00527 }
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00528}00528     \textcolor{preprocessor}{@property}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00529}00529     \textcolor{keyword}{def }light(self):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00530}00530         \textcolor{keywordflow}{if} (}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00531}00531             self.state != self.State.S2}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00532}00532             \textcolor{keywordflow}{or} self.mode == self.mode.blackout}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00533}00533             \textcolor{keywordflow}{or} \textcolor{keywordflow}{not} self.internal\_peak\_power}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00534}00534             \textcolor{keywordflow}{or} (self.analog2digital \textcolor{keywordflow}{and} \textcolor{keywordflow}{not} self.digital\_modulation)}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00539}00539     \textcolor{keyword}{def }write(self, data):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00540}00540         \textcolor{comment}{\# This connection does not wait for an eol to parse the}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00544}00544         self.handle(data)}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00547}00547     \textcolor{keyword}{def }handle(self, command):}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00548}00548         \textcolor{keywordflow}{if} len(command) != 16 \textcolor{keywordflow}{and} (}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00549}00549             len(command) != 7 \textcolor{keywordflow}{and} self.state != self.State.S2}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00564}00564             answer = self.state.name.encode()}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00571}00571                 + b\textcolor{stringliteral}{"{} \%3d"{}} \% (self.max\_power)  \textcolor{comment}{\# in mw}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00612}00612         \textcolor{keywordflow}{elif} command \textcolor{keywordflow}{in} self.command2mode.keys():}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00613}00613             \textcolor{keywordflow}{if} self.state == self.State.S2:}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00614}00614                 self.mode = self.command2mode[command]}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00621}00621             \textcolor{keywordflow}{if} self.state == self.State.S2:}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00622}00622                 answer = self.mode2answer[self.mode]}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00628}00628             \textcolor{keywordflow}{if} self.state == self.State.S1:}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00629}00629                 self.state = self.State.S2}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00630}00630                 answer = b\textcolor{stringliteral}{"{}LONOK"{}}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00631}00631             \textcolor{keywordflow}{elif} self.mode == self.Mode.S2:}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00640}00640             \textcolor{keywordflow}{if} self.state == self.State.S2:}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00641}00641                 self.state = self.State.S1}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00653}00653                 level = self.power / self.max\_power}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00657}00657                 self.power = level * self.max\_power}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00672}00672             level = self.power / self.max\_power}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00677}00677             self.internal\_peak\_power = \textcolor{keyword}{True}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00680}00680             self.internal\_peak\_power = \textcolor{keyword}{False}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00683}00683             answer = b\textcolor{stringliteral}{"{}IPO"{}} \textcolor{keywordflow}{if} self.internal\_peak\_power \textcolor{keywordflow}{else} b\textcolor{stringliteral}{"{}IPF"{}}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00688}00688             self.analog2digital = \textcolor{keyword}{True}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00691}00691             self.analog2digital = \textcolor{keyword}{False}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00694}00694             answer = b\textcolor{stringliteral}{"{}A2D ON"{}} \textcolor{keywordflow}{if} self.analog2digital \textcolor{keywordflow}{else} b\textcolor{stringliteral}{"{}A2D OFF"{}}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00698}00698             self.bias\_modulation = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00699}00699             self.digital\_modulation = \textcolor{keyword}{False}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00702}00702             self.bias\_modulation = \textcolor{keyword}{True}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00703}00703             self.digital\_modulation = \textcolor{keyword}{False}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00706}00706             self.bias\_modulation = \textcolor{keyword}{False}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00707}00707             self.digital\_modulation = \textcolor{keyword}{True}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00710}00710             self.bias\_modulation = \textcolor{keyword}{True}}
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00711}00711             self.digital\_modulation = \textcolor{keyword}{True}}
...
\DoxyCodeLine{\Hypertarget{mock__devices_8py_source_l00719}00719         self.in\_buffer.write(answer + self.eol)}
