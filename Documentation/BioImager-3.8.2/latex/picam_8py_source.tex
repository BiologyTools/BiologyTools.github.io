...
\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00001}00001 \textcolor{comment}{\#!/usr/bin/env python3}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00002}00002 }
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00003}00003 \textcolor{comment}{\#\# Copyright (C) 2016-\/2017 Mick Phillips <mick.phillips@gmail.com>}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00004}00004 \textcolor{comment}{\#\# Copyright (C) 2019 Ian Dobbie <ian.dobbie@bioch.ox.ac.uk>}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00005}00005 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00006}00006 \textcolor{comment}{\#\# This file is part of Microscope.}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00007}00007 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00008}00008 \textcolor{comment}{\#\# Microscope is free software: you can redistribute it and/or modify}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00009}00009 \textcolor{comment}{\#\# it under the terms of the GNU General Public License as published by}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00010}00010 \textcolor{comment}{\#\# the Free Software Foundation, either version 3 of the License, or}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00011}00011 \textcolor{comment}{\#\# (at your option) any later version.}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00012}00012 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00013}00013 \textcolor{comment}{\#\# Microscope is distributed in the hope that it will be useful,}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00014}00014 \textcolor{comment}{\#\# but WITHOUT ANY WARRANTY; without even the implied warranty of}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00015}00015 \textcolor{comment}{\#\# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00016}00016 \textcolor{comment}{\#\# GNU General Public License for more details.}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00017}00017 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00018}00018 \textcolor{comment}{\#\# You should have received a copy of the GNU General Public License}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00019}00019 \textcolor{comment}{\#\# along with Microscope.  If not, see <http://www.gnu.org/licenses/>.}}
...
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00037}00037 GPIO\_Trigger = 21}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00038}00038 GPIO\_CAMLED = 5}
...
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00046}00046     SOFTWARE = TriggerType.SOFTWARE}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00047}00047     EDGE\_RISING = TriggerType.RISING\_EDGE}
...
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00061}00061         self.\mbox{\hyperlink{classmicroscope_1_1cameras_1_1picam_1_1_pi_camera_a5440654a2f2c2592685ea6ea8bec05b0}{camera}} = \textcolor{keywordtype}{None}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00062}00062         \textcolor{comment}{\# Region of interest.}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00063}00063         self.\mbox{\hyperlink{classmicroscope_1_1cameras_1_1picam_1_1_pi_camera_a5ec69cf5f7b1f86758c2a814cf01d633}{roi}} = \mbox{\hyperlink{classmicroscope_1_1_r_o_i}{ROI}}(\textcolor{keywordtype}{None}, \textcolor{keywordtype}{None}, \textcolor{keywordtype}{None}, \textcolor{keywordtype}{None})}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00064}00064         \textcolor{comment}{\# Cycle time}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00065}00065         self.\mbox{\hyperlink{classmicroscope_1_1cameras_1_1picam_1_1_pi_camera_afafc78e1f3659591dc9d422a7f554e3b}{exposure\_time}} = 0.001  \textcolor{comment}{\# in seconds}}
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00066}00066         self.\mbox{\hyperlink{classmicroscope_1_1cameras_1_1picam_1_1_pi_camera_ab76b89bc864bb541ffcbe9ebbc017b47}{cycle\_time}} = self.\mbox{\hyperlink{classmicroscope_1_1cameras_1_1picam_1_1_pi_camera_afafc78e1f3659591dc9d422a7f554e3b}{exposure\_time}}}
...
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00119}00119     \textcolor{keyword}{def }get\_awb\_mode(self):}
...
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00122}00122     \textcolor{keyword}{def }set\_awb\_mode(self, val):}
...
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00127}00127     \textcolor{keyword}{def }set\_iso\_mode(self, val):}
...
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00155}00155         self.\mbox{\hyperlink{classmicroscope_1_1cameras_1_1picam_1_1_pi_camera_a5454b69673ffe603dc77edf73c87a8a2}{camversion}} = self.\mbox{\hyperlink{classmicroscope_1_1cameras_1_1picam_1_1_pi_camera_a5440654a2f2c2592685ea6ea8bec05b0}{camera}}.revision}
...
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00164}00164     \textcolor{keyword}{def }make\_safe(self):}
...
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00209}00209     \textcolor{keyword}{def }trigger\_mode(self) -\/> TriggerMode:}
...
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00217}00217     \textcolor{keyword}{def }trigger\_type(self) -\/> TriggerType:}
...
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00236}00236     \textcolor{keyword}{def }setLED(self, state=False):}
...
\DoxyCodeLine{\Hypertarget{picam_8py_source_l00263}00263     \textcolor{keyword}{def }soft\_trigger(self):}
