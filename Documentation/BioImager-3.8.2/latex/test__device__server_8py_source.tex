...
\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00001}00001 \textcolor{comment}{\#!/usr/bin/env python3}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00002}00002 }
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00003}00003 \textcolor{comment}{\#\# Copyright (C) 2020 David Miguel Susano Pinto <carandraug@gmail.com>}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00004}00004 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00005}00005 \textcolor{comment}{\#\# This file is part of Microscope.}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00006}00006 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00007}00007 \textcolor{comment}{\#\# Microscope is free software: you can redistribute it and/or modify}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00008}00008 \textcolor{comment}{\#\# it under the terms of the GNU General Public License as published by}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00009}00009 \textcolor{comment}{\#\# the Free Software Foundation, either version 3 of the License, or}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00010}00010 \textcolor{comment}{\#\# (at your option) any later version.}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00011}00011 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00012}00012 \textcolor{comment}{\#\# Microscope is distributed in the hope that it will be useful,}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00013}00013 \textcolor{comment}{\#\# but WITHOUT ANY WARRANTY; without even the implied warranty of}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00014}00014 \textcolor{comment}{\#\# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00015}00015 \textcolor{comment}{\#\# GNU General Public License for more details.}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00016}00016 \textcolor{comment}{\#\#}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00017}00017 \textcolor{comment}{\#\# You should have received a copy of the GNU General Public License}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00018}00018 \textcolor{comment}{\#\# along with Microscope.  If not, see <http://www.gnu.org/licenses/>.}}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00050}00050     \textcolor{keyword}{def }get\_pid(self) -\/> int:}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00059}00059 \textcolor{stringliteral}{    that happens during `run()` into the given queue so that the}}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00064}00064 \textcolor{stringliteral}{    }\textcolor{keyword}{def }\_\_init\_\_(self, queue: multiprocessing.Queue, *args, **kwargs) -\/> \textcolor{keywordtype}{None}:}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00065}00065         super().\_\_init\_\_(*args, **kwargs)}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00068}00068     \textcolor{keyword}{def }run(self):}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00069}00069         \textcolor{keywordflow}{try}:}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00070}00070             super().run()}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00107}00107 \textcolor{stringliteral}{    DEVICES = []}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00108}00108 \textcolor{stringliteral}{    TIMEOUT = 5}}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00111}00111     \textcolor{keyword}{def }setUp(self):}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00116}00116         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__device__server_1_1_base_test_serve_devices_aaa26c72948196803a21c71247adeb5d5}{p}} = multiprocessing.Process(}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00123}00123     \textcolor{keyword}{def }tearDown(self):}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00139}00139 \textcolor{stringliteral}{    args = []  }\textcolor{comment}{\# args to construct DeviceServer}}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00140}00140     TIMEOUT = 5  \textcolor{comment}{\# time to wait after join() during tearDown}}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00143}00143     \textcolor{keyword}{def }setUp(self):}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00144}00144         self.\mbox{\hyperlink{classmicroscope_1_1testsuite_1_1test__device__server_1_1_base_test_device_server_ab7580a0bc1dde32447423466d584d642}{queue}} = multiprocessing.Queue()}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00149}00149     \textcolor{keyword}{def }tearDown(self):}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00158}00158     DEVICES = [}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00159}00159         \mbox{\hyperlink{device__server_8py_a3ae40a0d7c733abb46179fe8b10d2ffb}{microscope.device\_server.device}}(}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00162}00162         \mbox{\hyperlink{device__server_8py_a3ae40a0d7c733abb46179fe8b10d2ffb}{microscope.device\_server.device}}(}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00185}00185     \textcolor{keyword}{def }\_\_init\_\_(self, port, **kwargs):}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00186}00186         super().\_\_init\_\_(**kwargs)}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00190}00190     \textcolor{keyword}{def }port(self):}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00200}00200     DEVICES = [}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00201}00201         \mbox{\hyperlink{device__server_8py_a3ae40a0d7c733abb46179fe8b10d2ffb}{microscope.device\_server.device}}(}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00206}00206     \textcolor{keyword}{def }test\_port\_conflict(self):}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00221}00221             module = \mbox{\hyperlink{device__server_8py_a4c4fffd5e0baa80fe0cff70f31047ed8}{microscope.device\_server.\_load\_source}}(filepath)}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00241}00241     DEVICES = [}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00242}00242         \mbox{\hyperlink{device__server_8py_a3ae40a0d7c733abb46179fe8b10d2ffb}{microscope.device\_server.device}}(}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00245}00245         \mbox{\hyperlink{device__server_8py_a3ae40a0d7c733abb46179fe8b10d2ffb}{microscope.device\_server.device}}(}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00250}00250     \textcolor{keyword}{def }test\_injection\_of\_index\_kwarg(self):}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00264}00264         \mbox{\hyperlink{device__server_8py_a3ae40a0d7c733abb46179fe8b10d2ffb}{microscope.device\_server.device}}(}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00298}00298     args = [}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00299}00299         \mbox{\hyperlink{device__server_8py_a3ae40a0d7c733abb46179fe8b10d2ffb}{microscope.device\_server.device}}(}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00326}00326     DEVICES = [}
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00327}00327         \mbox{\hyperlink{device__server_8py_a3ae40a0d7c733abb46179fe8b10d2ffb}{microscope.device\_server.device}}(}
...
\DoxyCodeLine{\Hypertarget{test__device__server_8py_source_l00336}00336     \textcolor{keyword}{def }test\_keep\_alive(self):}
