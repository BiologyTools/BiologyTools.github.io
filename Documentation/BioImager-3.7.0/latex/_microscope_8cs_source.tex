...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00028}00028         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{double} minX;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00029}00029         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{double} maxX;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00030}00030         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{double} minY;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00031}00031         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{double} maxY;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00032}00032         \textcolor{comment}{/* Creating a new instance of the Stage class. */}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00033}00033         \textcolor{keyword}{public} \mbox{\hyperlink{class_bio_imager_1_1_stage}{Stage}}(\textcolor{keywordtype}{object} st)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00037}00037                 PointD d = \mbox{\hyperlink{class_bio_imager_1_1_stage_a20fce9f3b88830c36ce0cd47df783da8}{GetPosition}}(\textcolor{keyword}{true});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00043}00043         \textcolor{keyword}{public} \mbox{\hyperlink{class_bio_imager_1_1_stage}{Stage}}()}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00050}00050         \textcolor{keyword}{public} \textcolor{keywordtype}{double} X}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00057}00057         \textcolor{keyword}{public} \textcolor{keywordtype}{double} Y}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00064}00064         \textcolor{keyword}{public} \textcolor{keywordtype}{int} moveWait = 250;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00067}00067             Thread.Sleep(moveWait);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00076}00076             \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.recordMicroscope)}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00077}00077                 \mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.AddLine(\textcolor{stringliteral}{"{}Microscope.Stage.SetPosition("{}} + px + \textcolor{stringliteral}{"{},"{}} + py + \textcolor{stringliteral}{"{});"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00082}00082                 Microscope.pMicroscope.SetPosition(\textcolor{keyword}{new} PointD(px, py));}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00087}00087                 PycroManager.SetPosition(\textcolor{keyword}{new} PointD(px, py));}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00096}00096                 Microscope.sdk.SetPosition(\textcolor{keyword}{new} PointD(px, py));}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00097}00097             \}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00098}00098             \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_bio_imager_1_1_app}{App}}.viewer != \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00099}00099                 \mbox{\hyperlink{class_bio_imager_1_1_app}{App}}.viewer.\mbox{\hyperlink{class_bio_imager_1_1_image_view_adc65e6e60745ab28f68c3e63642f547e}{UpdateView}}(\textcolor{keyword}{true});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00150}\mbox{\hyperlink{class_bio_imager_1_1_stage_a20fce9f3b88830c36ce0cd47df783da8}{00150}}         \textcolor{keyword}{public} PointD \mbox{\hyperlink{class_bio_imager_1_1_stage_a20fce9f3b88830c36ce0cd47df783da8}{GetPosition}}(\textcolor{keywordtype}{bool} update)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00154}00154                 PointD pd;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00161}00161                 PointD pd;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00170}00170                 \textcolor{keywordflow}{return} \textcolor{keyword}{new} PointD(com.doubles[0], com.doubles[1]);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00176}00176             \textcolor{keywordflow}{return} \textcolor{keyword}{new} PointD(x, y);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00222}00222                 minX = com.doubles[0];}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00223}00223                 minY = com.doubles[1];}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00224}00224                 maxX = com.doubles[2];}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00225}00225                 maxY = com.doubles[3];}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00243}00243             \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.recordMicroscope)}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00244}00244                 \mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.AddLine(\textcolor{stringliteral}{"{}Microscope.Focus.SetSWLimit("{}} + xmin + \textcolor{stringliteral}{"{},"{}} + xmax + \textcolor{stringliteral}{"{},"{}} + ymin + \textcolor{stringliteral}{"{},"{}} + ymax + \textcolor{stringliteral}{"{});"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00251}00251         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{double} upperLimit;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00252}00252         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{double} lowerLimit;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00254}00254         \textcolor{keyword}{public} \mbox{\hyperlink{class_bio_imager_1_1_focus}{Focus}}()}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00264}00264             \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.recordMicroscope)}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00265}00265                 \mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.AddLine(\textcolor{stringliteral}{"{}Microscope.Focus.SetFocus("{}} + f + \textcolor{stringliteral}{"{});"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00269}00269                 Microscope.pMicroscope.SetPosition(\textcolor{keyword}{new} Point3D(p.X,p.Y,f));}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00274}00274                 PointD p = Microscope.Stage.GetPosition(\textcolor{keyword}{true});}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00275}00275                 PycroManager.SetPosition(\textcolor{keyword}{new} Point3D(p.X, p.Y, f));}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00288}00288             \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_bio_imager_1_1_automation}{Automation}}.Properties.ContainsKey(\textcolor{stringliteral}{"{}SetFocus"{}}))}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00319}00319                 Point3D p;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00327}00327                 \textcolor{keywordflow}{return} com.doubles[0];}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00333}00333             \textcolor{keywordflow}{if}(\mbox{\hyperlink{class_bio_imager_1_1_automation}{Automation}}.Properties.ContainsKey(\textcolor{stringliteral}{"{}GetFocus"{}}))}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00343}\mbox{\hyperlink{class_bio_imager_1_1_focus_a4066fa2ce5019736fac41f717966b9cc}{00343}}         \textcolor{keyword}{public} PointD \mbox{\hyperlink{class_bio_imager_1_1_focus_a4066fa2ce5019736fac41f717966b9cc}{GetSWLimit}}()}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00349}00349                 upperLimit = com.doubles[0];}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00350}00350                 lowerLimit = com.doubles[1];}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00351}00351                 \textcolor{keywordflow}{return} \textcolor{keyword}{new} PointD(upperLimit,lowerLimit);}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00352}00352             \}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00353}00353             \textcolor{keywordflow}{return} \textcolor{keyword}{new} PointD(lowerLimit, upperLimit);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00369}00369             upperLimit = xd;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00370}00370             lowerLimit = yd;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00371}00371             \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.recordMicroscope)}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00372}00372                 \mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.AddLine(\textcolor{stringliteral}{"{}Microscope.Focus.SetSWLimit("{}} + xd + \textcolor{stringliteral}{"{},"{}} + yd + \textcolor{stringliteral}{"{});"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00379}00379         \textcolor{keyword}{public} List<Objective> List = \textcolor{keyword}{new} List<Objective>();}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00380}00380        \textcolor{comment}{/* Creating a list of objectives. */}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00381}00381         \textcolor{keyword}{public} \mbox{\hyperlink{class_bio_imager_1_1_objectives}{Objectives}}(\textcolor{keywordtype}{int} count)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00385}00385                 List.Add(\textcolor{keyword}{new} \mbox{\hyperlink{class_bio_imager_1_1_objectives_1_1_objective}{Objective}}(i));}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00391}00391             \textcolor{keyword}{public} Dictionary<string, object> config = \textcolor{keyword}{new} Dictionary<string, object>();}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00392}00392             \textcolor{keyword}{public} \textcolor{keywordtype}{int} Index;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00393}00393             \textcolor{keyword}{public} \textcolor{keywordtype}{string} Name;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00394}00394             \textcolor{keyword}{public} \textcolor{keywordtype}{double} LocateExposure = 50;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00395}00395             \textcolor{keyword}{public} \textcolor{keywordtype}{int} WorkingDistance = 0;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00396}00396             \textcolor{keyword}{public} \textcolor{keywordtype}{double} AcquisitionExposure = 50;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00397}00397             \textcolor{keyword}{public} \textcolor{keywordtype}{string} \mbox{\hyperlink{class_bio_imager_1_1_configuration}{Configuration}} = \textcolor{stringliteral}{"{}"{}};}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00398}00398             \textcolor{keyword}{public} \textcolor{keywordtype}{double} MoveAmountL = 40;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00399}00399             \textcolor{keyword}{public} \textcolor{keywordtype}{double} MoveAmountR = 10;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00400}00400             \textcolor{keyword}{public} \textcolor{keywordtype}{double} FocusMoveAmount = 0.02;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00401}00401             \textcolor{keyword}{public} \textcolor{keywordtype}{double} ViewWidth;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00402}00402             \textcolor{keyword}{public} \textcolor{keywordtype}{double} ViewHeight;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00403}00403             \textcolor{keyword}{public} \mbox{\hyperlink{class_bio_imager_1_1_objectives_1_1_objective}{Objective}}(\textcolor{keywordtype}{int} index)}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00404}00404             \{}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00405}00405                 Index = index;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00406}00406             \}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00407}00407             \textcolor{keyword}{public} \mbox{\hyperlink{class_bio_imager_1_1_objectives_1_1_objective}{Objective}}()}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00408}00408             \{}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00409}00409             \}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00410}00410             \textcolor{keyword}{public} \textcolor{keyword}{override} \textcolor{keywordtype}{string} ToString()}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00411}00411             \{}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00412}00412                 \textcolor{keywordflow}{if} (Name == \textcolor{stringliteral}{"{}"{}} || Name == \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00413}00413                     \textcolor{keywordflow}{return} \textcolor{stringliteral}{"{}Objective "{}} + Index.ToString();}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00414}00414                 \textcolor{keywordflow}{else} \textcolor{keywordflow}{return} Name;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00418}00418         \textcolor{keyword}{public} \textcolor{keywordtype}{int} moveWait = 1000;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00423}00423             Thread.Sleep(moveWait);}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00424}00424         \}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00425}00425         \textcolor{keyword}{public} \textcolor{keywordtype}{int} Index}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00429}00429                 \textcolor{keywordflow}{return} GetPosition();}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00445}00445             \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.recordMicroscope)}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00446}00446                 \mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.AddLine(\textcolor{stringliteral}{"{}Microscope.Objectives.SetObjective("{}} + index + \textcolor{stringliteral}{"{});"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00450}00450                 \mbox{\hyperlink{class_bio_imager_1_1_function}{Function}} f = \mbox{\hyperlink{class_bio_imager_1_1_function}{Function}}.Functions[\textcolor{stringliteral}{"{}SetO"{}} + index];}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00451}00451                 \mbox{\hyperlink{class_bio_imager_1_1_app}{App}}.imager.\mbox{\hyperlink{class_bio_imager_1_1_imager_acbaa41ce4ee9c71a18c94f55527618e0}{PerformFunction}}(f);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00466}00466         \textcolor{keyword}{public} \textcolor{keywordtype}{int} GetPosition()}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00472}00472                 \textcolor{keywordflow}{return} (\textcolor{keywordtype}{int})com.doubles[0];}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00482}00482             \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(!Properties.Settings.Default.PMicroscope \&\& Automation.Properties.ContainsKey(\textcolor{stringliteral}{"{}GetO1"{}}))}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00483}00483             \{}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00484}00484                 \textcolor{keywordflow}{if} (Function.Functions.ContainsKey(\textcolor{stringliteral}{"{}GetO7"{}}))}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00488}00488                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get01"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00491}00491                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get02"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00494}00494                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get03"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00497}00497                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get04"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00500}00500                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get05"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00503}00503                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get06"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00506}00506                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get07"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00514}00514                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get01"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00517}00517                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get02"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00520}00520                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get03"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00523}00523                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get04"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00526}00526                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get05"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00529}00529                     b = (bool)Automation.GetProperty(\textcolor{stringliteral}{"{}Get06"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00536}00536         \textcolor{keyword}{public} Objective GetObjective()}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00537}00537         \{}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00538}00538             \textcolor{keywordflow}{return} List[(short)GetPosition()];}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00545}00545         \textcolor{keyword}{public} \textcolor{keyword}{static} Type tlType;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00546}00546         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{object} tlShutter = \textcolor{keyword}{null};}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00547}00547         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{int} position;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00556}00556             \textcolor{keywordflow}{return} (\textcolor{keywordtype}{short})com.doubles[0];}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00567}00567             \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.recordMicroscope)}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00568}00568                 \mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.AddLine(\textcolor{stringliteral}{"{}Microscope.TLShutter.SetPosition("{}} + p + \textcolor{stringliteral}{"{});"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00573}00573                 position = p;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00587}00587         \textcolor{keyword}{public} \textcolor{keyword}{static} Type tlType;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00588}00588         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{object} tlShutter = \textcolor{keyword}{null};}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00589}00589         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{int} position;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00598}00598             \textcolor{keywordflow}{if} (com.doubles == \textcolor{keyword}{null})}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00599}00599                 \textcolor{keywordflow}{return} 0;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00600}00600             \textcolor{keywordflow}{return} (\textcolor{keywordtype}{short})com.doubles[0];}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00611}00611             \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.recordMicroscope)}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00612}00612                 \mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.AddLine(\textcolor{stringliteral}{"{}Microscope.TLShutter.SetPosition("{}} + p + \textcolor{stringliteral}{"{});"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00617}00617                 position = p;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00625}00625         \textcolor{keyword}{public} \textcolor{keyword}{static} Type rlType;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00626}00626         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{object} rlShutter = \textcolor{keyword}{null};}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00636}00636             \textcolor{keywordflow}{return} (\textcolor{keywordtype}{short})com.doubles[0];}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00651}00651             \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.recordMicroscope)}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00652}00652                 \mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.AddLine(\textcolor{stringliteral}{"{}Microscope.RLShutter.SetPosition("{}} + p + \textcolor{stringliteral}{"{});"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00659}00659         \textcolor{keyword}{public} \textcolor{keyword}{enum} Type}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00665}00665         \textcolor{keyword}{public} \textcolor{keywordtype}{double} position;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00666}00666         \textcolor{keyword}{public} Type type;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00667}00667         \textcolor{keywordtype}{string} name;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00668}00668         \textcolor{keyword}{public} \mbox{\hyperlink{class_bio_imager_1_1_light_source}{LightSource}}()}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00678}00678                 \textcolor{keywordflow}{if} (type == Type.HXP)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00684}00684                 \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(type == Type.RL)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00690}00690                 \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (type == Type.TL)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00694}00694                     \textcolor{keywordflow}{return} (\textcolor{keywordtype}{short})com.doubles[0];}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00695}00695                 \}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00696}00696             \}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00697}00697             \textcolor{keywordflow}{return} position;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00705}00705             \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.recordMicroscope)}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00706}00706                 \mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.AddLine(\textcolor{stringliteral}{"{}Microscope.LightSource.SetPosition("{}} + f + \textcolor{stringliteral}{"{});"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00709}00709                 \textcolor{keywordflow}{if} (type == Type.HXP)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00714}00714                 \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(type == Type.RL)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00719}00719                 \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (type == Type.TL)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00726}00726         \textcolor{keyword}{public} \textcolor{keyword}{override} \textcolor{keywordtype}{string} ToString()}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00736}00736         \textcolor{keyword}{public} \mbox{\hyperlink{class_bio_imager_1_1_filter_wheel}{FilterWheel}}() \{ \}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00737}00737         \textcolor{keyword}{public} \mbox{\hyperlink{class_bio_imager_1_1_filter_wheel}{FilterWheel}}(\textcolor{keywordtype}{object} o) }
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00749}00749                 \textcolor{keywordflow}{return} (\textcolor{keywordtype}{int})com.doubles[0];}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00775}00775                 \textcolor{keywordflow}{if} (\mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.recordMicroscope)}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00776}00776                     \mbox{\hyperlink{class_bio_imager_1_1_recorder}{Recorder}}.AddLine(\textcolor{stringliteral}{"{}Microscope.FilterWheel.SetPosition("{}} + i + \textcolor{stringliteral}{"{});"{}});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00798}00798             TakeImage,}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00820}00820         \textcolor{keyword}{public} \textcolor{keyword}{static} Point3D defaultPos = \textcolor{keyword}{new} Point3D(30000, 30000, 23900);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00823}00823         \textcolor{keyword}{public} \textcolor{keyword}{static} SDK sdk;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00826}00826         \textcolor{keyword}{public} \textcolor{keyword}{static} PointD viewSize;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00852}00852                 \textcolor{keywordtype}{bool} b = pMicroscope.SetPosition(\textcolor{keyword}{new} Point3D(100, 100, 100));}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00853}00853                 Point3D p;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00919}00919                 Point3D.SetLimits(Stage.minX, Stage.maxX, Stage.minY, Stage.maxY, Focus.lowerLimit, Focus.upperLimit);}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00920}00920                 PointD.SetLimits(Stage.minX, Stage.maxX, Stage.minY, Stage.maxY);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00926}00926                 sdk = \textcolor{keyword}{new} SDK();}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00950}00950                 \textcolor{keywordtype}{int} open = 0;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00960}00960                         open = sdk.Cmd(sessionID, \textcolor{stringliteral}{"{}controller.connect "{}} + port.ToString(), ref userRx, \textcolor{keyword}{false});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00970}00970                     MessageBox.Show(\textcolor{stringliteral}{"{}Error ("{}} + open.ToString() + \textcolor{stringliteral}{"{})  connecting to stage controller "{}}, \textcolor{stringliteral}{"{}"{}},}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00980}00980             RectangleD rec = GetObjectiveViewRectangle();}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00981}00981             viewSize = \textcolor{keyword}{new} PointD(rec.W, rec.H);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l00996}00996                 PointD cur = Stage.GetPosition(\textcolor{keyword}{true});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01009}01009         \textcolor{keyword}{public} \textcolor{keyword}{static} Point3D GetPosition()}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01010}01010         \{}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01011}01011             PointD p = Stage.GetPosition(\textcolor{keyword}{false});}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01012}01012             \textcolor{keywordtype}{double} f = Focus.GetFocus();}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01013}01013             \textcolor{keywordflow}{return} \textcolor{keyword}{new} Point3D(p.X, p.Y, f);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01020}01020         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{void} SetPosition(Point3D p)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01030}01030         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{void} SetPosition(PointD p)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01236}01236         \textcolor{keyword}{public} \textcolor{keyword}{static} BioImage TakeImage()}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01237}01237         \{}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01238}01238             \textcolor{keywordflow}{return} TakeImage(\textcolor{keyword}{true},\textcolor{keyword}{true},\textcolor{keyword}{false});}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01239}01239         \}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01240}01240 }
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01241}01241         \textcolor{keyword}{public} \textcolor{keyword}{static} BioImage TakeImage(\textcolor{keywordtype}{bool} save, \textcolor{keywordtype}{bool} addToImages, \textcolor{keywordtype}{bool} newTab)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01247}01247                 Point3D p = GetPosition();}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01251}01251                 RectangleD view = Microscope.GetViewRectangle(\textcolor{keyword}{true});}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01256}01256                 \textcolor{keywordtype}{string} file;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01258}01258                     file = Properties.Settings.Default.ImageName + (ImageCount++) + \textcolor{stringliteral}{"{}.ome.tif"{}};}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01259}01259                 \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01260}01260                     file = folder + \textcolor{stringliteral}{"{}/"{}} + Properties.Settings.Default.ImageName + (ImageCount++) + \textcolor{stringliteral}{"{}.ome.tif"{}};}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01261}01261                 b.ID = file;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01262}01262                 b.file = file;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01272}01272                 \textcolor{keywordtype}{string} file;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01274}01274                     file = Properties.Settings.Default.ImageName + (ImageCount++).ToString();}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01275}01275                 \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01276}01276                     file = folder + \textcolor{stringliteral}{"{}/"{}} + Properties.Settings.Default.ImageName + (ImageCount++);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01280}01280                 PixelFormat px;}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01281}01281                 Enum.TryParse<PixelFormat>(Properties.Settings.Default.PCameraFormat, out px);}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01282}01282                 pMicroscope.GetSize(out w, out h);}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01283}01283                 Bitmap bf = \textcolor{keyword}{new} Bitmap(file, w, h, px, bts, \textcolor{keyword}{new} ZCT(0, 0, 0), 0);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01288}01288                 RectangleD rec = GetViewRectangle(\textcolor{keyword}{false});}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01289}01289                 Point3D p = Microscope.GetPosition();}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01329}01329                 \textcolor{keywordtype}{string} file;}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01331}01331                     file = Properties.Settings.Default.ImageName + (ImageCount++).ToString();}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01332}01332                 \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01333}01333                     file = folder + \textcolor{stringliteral}{"{}/"{}} + Properties.Settings.Default.ImageName + (ImageCount++);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01451}01451                 TakeImage();}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01475}01475             RectangleD rec = GetObjectiveViewRectangle();}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01482}01482             bi.Volume = \textcolor{keyword}{new} VolumeD(\textcolor{keyword}{new} Point3D(bi.StageSizeX, bi.StageSizeY, bi.StageSizeZ),\textcolor{keyword}{new} Point3D(bi.SizeX * bi.PhysicalSizeX, bi.SizeY * bi.PhysicalSizeY, bi.StageSizeZ * bi.PhysicalSizeZ));}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01508}01508                 Point3D p = Microscope.GetPosition();}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01554}01554         \textcolor{keyword}{public} \textcolor{keyword}{static} RectangleD GetObjectiveViewRectangle()}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01557}01557             PointD d = Stage.GetPosition(\textcolor{keyword}{false});}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01558}01558             \textcolor{keywordflow}{return} \textcolor{keyword}{new} RectangleD(d.X, d.Y, o.ViewWidth, o.ViewHeight);}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01559}01559         \}}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01567}01567         \textcolor{keyword}{public} \textcolor{keyword}{static} RectangleD GetViewRectangle(\textcolor{keywordtype}{bool} update)}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01571}01571                 PointD d = Stage.GetPosition(\textcolor{keyword}{false});}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01572}01572                 \textcolor{keywordflow}{return} \textcolor{keyword}{new} RectangleD(d.X, d.Y, viewSize.X, viewSize.Y);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01578}01578                     \textcolor{keywordflow}{return} \textcolor{keyword}{new} RectangleD(PMicroscope.location.X, PMicroscope.location.Y, viewSize.X, viewSize.Y);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01582}01582                     PointD d = Stage.GetPosition(\textcolor{keyword}{false});}
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01583}01583                     \textcolor{keywordflow}{return} \textcolor{keyword}{new} RectangleD(d.X, d.Y, viewSize.X, viewSize.Y);}
...
\DoxyCodeLine{\Hypertarget{_microscope_8cs_source_l01587}01587         \textcolor{keyword}{public} \textcolor{keyword}{static} \textcolor{keywordtype}{void} Close()}
